...
- Marid (Disguises)
---
# [Marid (Disguises)](CLI/bestiary/elemental/marid-disguises.md)
...
- "desc": "The marid's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ ([water elemental](/CLI/bestiary/elemental/water-elemental.md) only), [control\
    \ water](/CLI/spells/control-water.md), [gaseous form](/CLI/spells/gaseous-form.md),\
    \ [invisibility](/CLI/spells/invisibility.md), [plane shift](/CLI/spells/plane-shift.md)\n\
    \n3/day each: [tongues](/CLI/spells/tongues.md), [water breathing](/CLI/spells/water-breathing.md),\
    \ [water walk](/CLI/spells/water-walk.md), [true polymorph](/CLI/spells/true-polymorph.md)\
