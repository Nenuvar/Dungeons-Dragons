...
- "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
    ...
    \ is Large or smaller, it is also [grappled](/CLI/conditions.md#Grappled) (escape\
    \ DC 14). Until this grapple ends, the target is [restrained](/CLI/conditions.md#Restrained)\
    ...
    \ the start of each of the elemental's turns, each target [grappled](/CLI/conditions.md#Grappled)\
...
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/water-elemental.webp"
```
^statblock
