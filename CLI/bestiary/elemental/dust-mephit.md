...
"cr": "1/2"
"traits":
- "desc": "The mephit can innately cast [sleep](/CLI/spells/sleep.md), requiring no\
...
- "desc": "When the mephit dies, it explodes in a burst of dust. Each creature within\
    \ 5 feet of it must then succeed on a DC 10 Constitution saving throw or be [blinded](/CLI/conditions.md#Blinded)\
    \ for 1 minute. A [blinded](/CLI/conditions.md#Blinded) creature can repeat the\
...
- "desc": "The mephit exhales a 15-foot cone of blinding dust. Each creature in that\
    \ area must succeed on a DC 10 Dexterity saving throw or be [blinded](/CLI/conditions.md#Blinded)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success."
  "name": "Blinding Breath (Recharge 6)"
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/dust-mephit.webp"
```
^statblock
