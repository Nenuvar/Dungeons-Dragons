...
- Dao (Wishes)
---
# [Dao (Wishes)](CLI/bestiary/elemental/dao-wishes.md)
...
- "desc": "The dao's innate spellcasting ability is Charisma (spell save DC 14, +6\
    ...
    \ [detect magic](/CLI/spells/detect-magic.md), [stone shape](/CLI/spells/stone-shape.md)\n\
    \n1/day each: [conjure elemental](/CLI/spells/conjure-elemental.md) ([earth\
    \ elemental](/CLI/bestiary/elemental/earth-elemental.md) only), [gaseous form](/CLI/spells/gaseous-form.md),\
    \ [invisibility](/CLI/spells/invisibility.md), [phantasmal killer](/CLI/spells/phantasmal-killer.md),\
    \ [plane shift](/CLI/spells/plane-shift.md), [wall of stone](/CLI/spells/wall-of-stone.md)\n\
    \n3/day each: [passwall](/CLI/spells/passwall.md), [move earth](/CLI/spells/move-earth.md),\
...
- "desc": "The dao has advantage on Strength and Dexterity saving throws made against\
    \ effects that would knock it [prone](/CLI/conditions.md#Prone)."
  "name": "Sure-Footed"
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit: 20\
    ...
    \ it must succeed on a DC 18 Strength check or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Maul"
"source":
- "MM"
```
