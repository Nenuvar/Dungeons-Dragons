...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11\
    ...
    \ [grappled](/CLI/conditions.md#Grappled) (escape DC 14). Until this grapple ends,\
    \ the target is [restrained](/CLI/conditions.md#Restrained), the salamander can\
    \ automatically hit the target with its tail, and the salamander can't make tail\
    \ attacks against other targets."
  "name": "Tail"
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/salamander.webp"
```
^statblock
