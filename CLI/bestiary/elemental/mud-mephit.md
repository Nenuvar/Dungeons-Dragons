...
- "desc": "When the mephit dies, it explodes in a burst of sticky mud. Each Medium\
    ...
    \ throw or be [restrained](/CLI/conditions.md#Restrained) until the end of the\
...
- "desc": "The mephit belches viscid mud onto one creature within 5 feet of it. If\
    ...
    \ throw or be [restrained](/CLI/conditions.md#Restrained) for 1 minute. A creature\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/elemental/token/mud-mephit.webp"
```
^statblock
