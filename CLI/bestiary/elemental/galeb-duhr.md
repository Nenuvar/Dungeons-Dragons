...
*Source: Monster Manual p. 139, The Wild Beyond the Witchlight*  
...
- "desc": "The galeb duhr magically animates up to two boulders it can see within\
    ...
    \ has Intelligence 1 and Charisma 1, it can't be [charmed](/CLI/conditions.md#Charmed)\
    \ or [frightened](/CLI/conditions.md#Frightened), and it lacks this action option.\
    \ A boulder remains animated as long as the galeb duhr maintains [concentration](/CLI/conditions.md#Concentration),\
    \ up to 1 minute (as if [concentrating](/CLI/conditions.md#Concentration) on a\
    \ spell)."
  "name": "Animate Boulders (1/Day)"
"source":
- "MM"
- "WBtW"
"image": "/CLI/bestiary/elemental/token/galeb-duhr.webp"
```
^statblock
