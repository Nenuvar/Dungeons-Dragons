...
"cr": "1/2"
"traits":
- "desc": "The mephit can innately cast [fog cloud](/CLI/spells/fog-cloud.md), requiring\
    \ no material components. Its innate spellcasting ability is Charisma.\n\nAt\
    \ will: [fog cloud](/CLI/spells/fog-cloud.md)"
...
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/ice-mephit.webp"
```
^statblock
