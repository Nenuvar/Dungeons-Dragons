...
- Efreeti (Disguises)
---
# [Efreeti (Disguises)](CLI/bestiary/elemental/efreeti-disguises.md)
...
- "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ ([fire elemental](/CLI/bestiary/elemental/fire-elemental.md) only), [gaseous\
    ...
    \ [wall of fire](/CLI/spells/wall-of-fire.md)\n\n3/day each: [enlarge/reduce](/CLI/spells/enlarge-reduce.md),\
    \ [tongues](/CLI/spells/tongues.md), [true polymorph](/CLI/spells/true-polymorph.md)\
