...
- Marid (Wishes)
---
# [Marid (Wishes)](CLI/bestiary/elemental/marid-wishes.md)
...
- "desc": "The marid's innate spellcasting ability is Charisma (spell save DC 16,\
    ...
    \ requiring no material components:\n\nAt will: [create or destroy water](/CLI/spells/create-or-destroy-water.md),\
    \ [detect evil and good](/CLI/spells/detect-evil-and-good.md), [detect magic](/CLI/spells/detect-magic.md),\
    \ [fog cloud](/CLI/spells/fog-cloud.md), [purify food and drink](/CLI/spells/purify-food-and-drink.md)\n\
    \n1/day each: [conjure elemental](/CLI/spells/conjure-elemental.md) ([water\
    \ elemental](/CLI/bestiary/elemental/water-elemental.md) only), [control water](/CLI/spells/control-water.md),\
    \ [gaseous form](/CLI/spells/gaseous-form.md), [invisibility](/CLI/spells/invisibility.md),\
    \ [plane shift](/CLI/spells/plane-shift.md)\n\n3/day each: [tongues](/CLI/spells/tongues.md),\
    \ [water breathing](/CLI/spells/water-breathing.md), [water walk](/CLI/spells/water-walk.md)"
...
- "desc": "The genie power to grant wishes is legendary among mortals. Only the most\
    ...
    \ the genie states a desired effect to it. The genie can then cast the [wish](/CLI/spells/wish.md)\
...
- "desc": "The marid magically shoots water in a 60-foot line that is 5 feet wide.\
    ...
    \ is pushed up to 20 feet away from the marid and knocked [prone](/CLI/conditions.md#Prone).\
    \ On a success, a target takes half the bludgeoning damage, but is neither pushed\
    \ nor knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Water Jet"
"source":
- "MM"
```
