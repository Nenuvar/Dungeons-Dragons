...
- Efreeti (Wishes)
---
# [Efreeti (Wishes)](CLI/bestiary/elemental/efreeti-wishes.md)
...
- "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \n1/day each: [conjure elemental](/CLI/spells/conjure-elemental.md) ([fire\
    \ elemental](/CLI/bestiary/elemental/fire-elemental.md) only), [gaseous form](/CLI/spells/gaseous-form.md),\
    \ [invisibility](/CLI/spells/invisibility.md), [major image](/CLI/spells/major-image.md),\
    \ [plane shift](/CLI/spells/plane-shift.md), [wall of fire](/CLI/spells/wall-of-fire.md)\n\
    \n3/day each: [enlarge/reduce](/CLI/spells/enlarge-reduce.md), [tongues](/CLI/spells/tongues.md)"
