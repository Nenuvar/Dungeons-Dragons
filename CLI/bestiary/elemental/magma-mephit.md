...
"cr": "1/2"
"traits":
- "desc": "The mephit can innately cast [heat metal](/CLI/spells/heat-metal.md) (spell\
    \ save DC 10), requiring no material components. Its innate spellcasting ability\
    \ is Charisma.\n\nAt will: [heat metal](/CLI/spells/heat-metal.md)"
...
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/magma-mephit.webp"
```
^statblock
