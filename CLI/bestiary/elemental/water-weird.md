...
"condition_immunities": "[exhaustion](/CLI/conditions.md#Exhaustion), [grappled](/CLI/conditions.md#Grappled),\
  ...
  \ [restrained](/CLI/conditions.md#Restrained), [prone](/CLI/conditions.md#Prone),\
  \ [unconscious](/CLI/conditions.md#Unconscious)"
"senses": "blindsight 30 ft., passive Perception 10"
"languages": "understands Aquan but doesn't speak"
"cr": "3"
"traits":
- "desc": "The water weird is [invisible](/CLI/conditions.md#Invisible) while fully\
    \ immersed in water."
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ [grappled](/CLI/conditions.md#Grappled) (escape DC 13) and pulled 5 feet toward\
    \ the water weird. Until this grapple ends, the target is [restrained](/CLI/conditions.md#Restrained),\
    \ the water weird tries to drown it, and the water weird can't constrict another\
    \ target."
  "name": "Constrict"
"source":
- "MM"
"image": "/CLI/bestiary/elemental/token/water-weird.webp"
```
^statblock
