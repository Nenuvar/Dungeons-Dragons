...
- "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
    ...
    \ the creature is [frightened](/CLI/conditions.md#Frightened) for 1 minute. A\
    \ creature can repeat the saving throw at the end of each of its turns, with disadvantage\
    \ if the hag is within line of sight, ending the effect on itself on a success.\
    \ If a creature's saving throw is successful or the effect ends for it, the creature\
    \ is immune to the hag's Horrific Appearance for the next 24 hours.\n\nUnless\
    \ the target is [surprised](/CLI/conditions.md#Surprised) or the revelation of\
    \ the hag's true form is sudden, the target can avert its eyes and avoid making\
    \ the initial saving throw. Until the start of its next turn, a creature that\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
  ...
  "name": "Claws"
- "desc": "The hag targets one [frightened](/CLI/conditions.md#Frightened) creature\
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ inspect the illusion and succeed on a DC 16 Intelligence ([Investigation](/CLI/skills.md#Investigation))\
...
- "desc": "- The hag fills up to four 10-foot cubes of water with ink. The inky areas\
    ...
    \ creates a simulacrum of that creature (as if created with the [simulacrum](/CLI/spells/simulacrum.md)\
...
"source":
- "MM"
"image": "/CLI/bestiary/fey/token/sea-hag.webp"
```
^statblock
