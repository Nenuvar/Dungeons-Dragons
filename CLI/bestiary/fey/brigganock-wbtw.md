...
- Brigganock
---
# [Brigganock](CLI/bestiary/fey/brigganock-wbtw.md)
...
"saves":
  "Dexterity": !!int "4"
  "Constitution": !!int "4"
"condition_immunities": "[exhaustion](/CLI/conditions.md#Exhaustion)"
...
- "desc": "The brigganock casts one of the following spells, requiring no material\
    ...
    \nAt will: [minor illusion](/CLI/spells/minor-illusion.md), [spare the dying](/CLI/spells/spare-the-dying.md)\n\
    \n1/day each: [animal friendship](/CLI/spells/animal-friendship.md), [faerie\
    \ fire](/CLI/spells/faerie-fire.md), [meld into stone](/CLI/spells/meld-into-stone.md),\
    \ [silence](/CLI/spells/silence.md)"
  "name": "Spellcasting"
- "desc": "The brigganock has advantage on saving throws against being [charmed](/CLI/conditions.md#Charmed),\
