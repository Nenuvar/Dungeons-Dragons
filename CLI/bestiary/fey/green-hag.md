...
> 
> 1st level (4 slots): [identify](/CLI/spells/identify.md), [ray of sickness](/CLI/spells/ray-of-sickness.md)  
> 2nd level (3 slots): [hold person](/CLI/spells/hold-person.md), [locate object](/CLI/spells/locate-object.md)  
> 3rd level (3 slots): [bestow curse](/CLI/spells/bestow-curse.md), [counterspell](/CLI/spells/counterspell.md), [lightning bolt](/CLI/spells/lightning-bolt.md)  
> 4th level (3 slots): [phantasmal killer](/CLI/spells/phantasmal-killer.md), [polymorph](/CLI/spells/polymorph.md)  
> 5th level (2 slots): [contact other plane](/CLI/spells/contact-other-plane.md), [scrying](/CLI/spells/scrying.md)  
> 6th level (1 slot): [eyebite](/CLI/spells/eyebite.md)  
> 
...
- "desc": "The hag's innate spellcasting ability is Charisma (spell save DC 12). She\
    ...
    At will: [dancing lights](/CLI/spells/dancing-lights.md), [minor illusion](/CLI/spells/minor-illusion.md),\
...
- "desc": "The hag can mimic animal sounds and humanoid voices. A creature that hears\
    \ the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](/CLI/skills.md#Insight))\
    \ check."
  "name": "Mimicry"
"actions":
...
- "desc": "The hag covers herself and anything she is wearing or carrying with a magical\
    ...
    \ visually inspect the illusion and succeed on a DC 20 Intelligence ([Investigation](/CLI/skills.md#Investigation))\
    \ check to discern that the hag is disguised."
  "name": "Illusory Appearance"
- "desc": "The hag magically turns [invisible](/CLI/conditions.md#Invisible) until\
    \ she attacks or casts a spell, or until her [concentration](/CLI/conditions.md#Concentration)\
    \ ends (as if [concentrating](/CLI/conditions.md#Concentration) on a spell). While\
    \ [invisible](/CLI/conditions.md#Invisible), she leaves no physical evidence of\
    \ her passage, so she can be tracked only by magic. Any equipment she wears or\
    \ carries is [invisible](/CLI/conditions.md#Invisible) with her."
...
- "desc": "- Birds, rodents, snakes, spiders, or toads (or some other creatures appropriate\
    ...
    \ score of 2 or lower are [charmed](/CLI/conditions.md#Charmed) by the hag and\
    \ directed to be aggressive toward intruders in the area.  \n- Strange carved\
...
- "desc": "- Illusory duplicates of the hag appear in random places at random times\
    ...
    \ are thick with reeking mud.  \n- Trees transform into [awakened trees](/CLI/bestiary/plant/awakened-tree.md)\
    \ and attack when hostile intruders are near.  "
  "name": ""
"source":
- "MM"
- "WBtW"
"image": "/CLI/bestiary/fey/token/green-hag.webp"
```
^statblock
