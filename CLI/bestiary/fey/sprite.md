...
*Source: Monster Manual p. 283, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Ranged Weapon Attack: +6 to hit, range 40/160 ft., one target. Hit:\
    ...
    \ throw or become [poisoned](/CLI/conditions.md#Poisoned) for 1 minute. If its\
    \ saving throw result is 5 or lower, the [poisoned](/CLI/conditions.md#Poisoned)\
    \ target falls [unconscious](/CLI/conditions.md#Unconscious) for the same duration,\
...
- "desc": "The sprite touches a creature and magically knows the creature's current\
  ...
  "name": "Heart Sight"
- "desc": "The sprite magically turns [invisible](/CLI/conditions.md#Invisible) until\
    \ it attacks or casts a spell, or until its [concentration](/CLI/conditions.md#Concentration)\
    \ ends (as if [concentrating](/CLI/conditions.md#Concentration) on a spell). Any\
    \ equipment the sprite wears or carries is [invisible](/CLI/conditions.md#Invisible)\
    \ with it."
  "name": "Invisibility"
"source":
- "MM"
- "WBtW"
"image": "/CLI/bestiary/fey/token/sprite.webp"
```
^statblock
