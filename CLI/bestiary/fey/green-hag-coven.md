...
- Green Hag (Coven)
---
# [Green Hag (Coven)](CLI/bestiary/fey/green-hag-coven.md)
...
- "desc": "While all three members of a hag coven are within 30 feet of one another,\
    ...
    \ share the spell slots among themselves:\n\n1st level (4 slots): [identify](/CLI/spells/identify.md),\
    \ [ray of sickness](/CLI/spells/ray-of-sickness.md)\n\n2nd level (3 slots):\
    \ [hold person](/CLI/spells/hold-person.md), [locate object](/CLI/spells/locate-object.md)\n\
    \n3rd level (3 slots): [bestow curse](/CLI/spells/bestow-curse.md), [counterspell](/CLI/spells/counterspell.md),\
    \ [lightning bolt](/CLI/spells/lightning-bolt.md)\n\n4th level (3 slots):\
    \ [phantasmal killer](/CLI/spells/phantasmal-killer.md), [polymorph](/CLI/spells/polymorph.md)\n\
    \n5th level (2 slots): [contact other plane](/CLI/spells/contact-other-plane.md),\
    \ [scrying](/CLI/spells/scrying.md)\n\n6th level (1 slots): [eyebite](/CLI/spells/eyebite.md)\n\
