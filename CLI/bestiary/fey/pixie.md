...
*Source: Monster Manual p. 253, The Wild Beyond the Witchlight*  
...
- "desc": "The pixie's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \ each: [confusion](/CLI/spells/confusion.md), [dancing lights](/CLI/spells/dancing-lights.md),\
    \ [detect evil and good](/CLI/spells/detect-evil-and-good.md), [detect thoughts](/CLI/spells/detect-thoughts.md),\
    \ [dispel magic](/CLI/spells/dispel-magic.md), [entangle](/CLI/spells/entangle.md),\
    \ [fly](/CLI/spells/fly.md), [phantasmal force](/CLI/spells/phantasmal-force.md),\
    \ [polymorph](/CLI/spells/polymorph.md), [sleep](/CLI/spells/sleep.md)"
  "name": "Innate Spellcasting"
- "desc": "The pixie has advantage on saving throws against spells and other magical\
    \ effects."
  "name": "Magic Resistance"
"actions":
- "desc": "The pixie magically turns [invisible](/CLI/conditions.md#Invisible) until\
    \ its [concentration](/CLI/conditions.md#Concentration) ends (as if [concentrating](/CLI/conditions.md#Concentration)\
    \ on a spell). Any equipment the pixie wears or carries is [invisible](/CLI/conditions.md#Invisible)\
    \ with it."
  "name": "Superior Invisibility"
"source":
- "MM"
- "WBtW"
"image": "/CLI/bestiary/fey/token/pixie.webp"
```
^statblock
