...
- Redcap
---
# [Redcap](CLI/bestiary/fey/redcap-vgm.md)
...
"cr": "3"
"traits":
- "desc": "While moving, the redcap has disadvantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
    \ checks."
  "name": "Iron Boots"
...
- "desc": "The redcap moves up to its speed to a creature it can see and kicks with\
    ...
    \ take 20 (3d10 + 4) bludgeoning damage and be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Ironbound Pursuit"
"source":
- "VGM"
- "WBtW"
"image": "/CLI/bestiary/fey/token/redcap-vgm.webp"
```
^statblock
