...
---
# [Thri-kreen (Weapons and Psionics)](CLI/bestiary/humanoid/thri-kreen-weapons-and-psionics.md)
...
- "desc": "The thri-kreen's innate spellcasting ability is Wisdom. The thri-kreen\
    ...
    \ [mage hand](/CLI/spells/mage-hand.md) (the hand is [invisible](/CLI/conditions.md#Invisible))\n\
    \n1/day: [invisibility](/CLI/spells/invisibility.md) (self only)\n\n2/day\
    \ each: [blur](/CLI/spells/blur.md), [magic weapon](/CLI/spells/magic-weapon.md)"
...
- "desc": "The thri-kreen can change the color of its carapace to match the color\
    ...
    \ ([Stealth](/CLI/skills.md#Stealth)) checks made to hide."
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ saving throw or be [poisoned](/CLI/conditions.md#Poisoned) for 1 minute. If\
    \ the saving throw fails by 5 or more, the target is also [paralyzed](/CLI/conditions.md#Paralyzed)\
    \ while [poisoned](/CLI/conditions.md#Poisoned) in this way. The [poisoned](/CLI/conditions.md#Poisoned)\
