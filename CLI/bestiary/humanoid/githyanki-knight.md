...
These silver swords channel the force of the wielder's will, dealing psychic as well as physical damage. A githyanki can't become a knight until it masters the singular discipline needed to will such a blade into existence. A silver sword is equivalent to a [greatsword](/CLI/items/greatsword.md), and takes on the properties of a [+3 greatsword](/CLI/items/3-weapon.md) in the hands of its creator.
...
- "desc": "The githyanki's innate spellcasting ability is Intelligence (spell save\
    ...
    \ [telekinesis](/CLI/spells/telekinesis.md)\n\n3/day each: [jump](/CLI/spells/jump.md),\
    \ [misty step](/CLI/spells/misty-step.md), [nondetection](/CLI/spells/nondetection.md)\
    \ (self only), [tongues](/CLI/spells/tongues.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 13\
    ...
    \ the [astral projection](/CLI/spells/astral-projection.md) spell), the githyanki\
...
- "MM"
- "LoX"
"image": "/CLI/bestiary/humanoid/token/githyanki-knight.webp"
```
^statblock