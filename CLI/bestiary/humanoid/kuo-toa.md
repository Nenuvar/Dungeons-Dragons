...
"ac": !!int "13"
"ac_class": "natural armor, [shield](/CLI/items/shield.md)"
"hp": !!int "18"
"hit_dice": "4d8"
"stats":
- !!int "13"
...
- "desc": "Ranged Weapon Attack: +3 to hit, range 5/15 ft., one Large or smaller\
    \ creature. Hit: The target is [restrained](/CLI/conditions.md#Restrained).\
...
- "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
    ...
    \ [grappled](/CLI/conditions.md#Grappled) while the weapon is stuck. While stuck,\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/kuo-toa.webp"
```
^statblock
