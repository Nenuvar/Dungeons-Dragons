...
- "desc": "The lizardfolk is a 5th-level spellcaster. Its spellcasting ability is\
    ...
    \ [produce flame](/CLI/spells/produce-flame.md), [thorn whip](/CLI/spells/thorn-whip.md)\n\
    \n1st level (4 slots): [entangle](/CLI/spells/entangle.md), [fog cloud](/CLI/spells/fog-cloud.md)\n\
    \n2nd level (3 slots): [heat metal](/CLI/spells/heat-metal.md), [spike growth](/CLI/spells/spike-growth.md)\n\
    \n3rd level (2 slots): [conjure animals](/CLI/spells/conjure-animals.md) (reptiles\
    \ only), [plant growth](/CLI/spells/plant-growth.md)"
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    \ + 2) piercing damage, or 7 (1d10 + 2) piercing damage in [crocodile](/CLI/bestiary/beast/crocodile.md)\
    \ form. If the lizardfolk is in crocodile form and the target is a Large or smaller\
    \ creature, the target is [grappled](/CLI/conditions.md#Grappled) (escape DC 12).\
    \ Until this grapple ends, the target is [restrained](/CLI/conditions.md#Restrained),\
...
- "desc": "The lizardfolk magically polymorphs into a [crocodile](/CLI/bestiary/beast/crocodile.md),\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/lizardfolk-shaman.webp"
```
^statblock
