...
The Underdark is saturated with strange magical power, which the duergar absorbed over generations of imprisonment. A duergar can increase its size and strength for a short time, becoming a powerful ogre-sized warrior. If it faces a foe it can't fight, or when spying on creatures approaching its territory, it can just as easily become [invisible](/CLI/conditions.md#Invisible) to slip away into the darkness. Eons spent in the Underdark also sharpened their [darkvision](/CLI/senses.md#Darkvision), allowing them to see twice as far as other dwarves. This keen eyesight comes at a cost, however, as a duergar's vision is compromised by sunlight.
...
"ac": !!int "16"
"ac_class": "[scale mail](/CLI/items/scale-mail.md), [shield](/CLI/items/shield.md)"
"hp": !!int "26"
"hit_dice": "4d8 + 4"
"stats":
- !!int "14"
...
- "desc": "The duergar has advantage on saving throws against poison, spells, and\
    \ illusions, as well as to resist being [charmed](/CLI/conditions.md#Charmed)\
    \ or [paralyzed](/CLI/conditions.md#Paralyzed)."
...
- "desc": "Melee or Ranged Weapon Attack: +4 to hit, reach 5 ft. or range 30/120\
  ...
  "name": "Javelin"
- "desc": "The duergar magically turns [invisible](/CLI/conditions.md#Invisible) until\
    \ it attacks, casts a spell, or uses its Enlarge, or until its [concentration](/CLI/conditions.md#Concentration)\
    \ is broken, up to 1 hour (as if [concentrating](/CLI/conditions.md#Concentration)\
    \ on a spell). Any equipment the duergar wears or carries is [invisible](/CLI/conditions.md#Invisible)\
    \ with it."
  "name": "Invisibility (Recharges after a Short or Long Rest)"
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/duergar.webp"
```
^statblock
