...
Jackalweres kidnap humanoids for their lamia masters, condemning victims to a lifetime of slavery or an agonizing death. A jackalwere's magical gaze renders a foe [unconscious](/CLI/conditions.md#Unconscious), allowing the monster to bind a creature or drag it away.
...
- "desc": "The jackalwere can use its action to polymorph into a specific Medium human\
    ...
    \ it dies."
  "name": "Shapechanger"
- "desc": "The jackalwere has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "The jackalwere has advantage on an attack roll against a creature if at\
    ...
    \ ally isn't [incapacitated](/CLI/conditions.md#Incapacitated)."
  "name": "Pack Tactics"
"actions":
...
- "desc": "The jackalwere gazes at one creature it can see within 30 feet of it. The\
    ...
    \ to a magical slumber, falling [unconscious](/CLI/conditions.md#Unconscious)\
    ...
    \ gaze for the next 24 hours. Undead and creatures immune to being [charmed](/CLI/conditions.md#Charmed)\
    \ aren't affected by it."
  "name": "Sleep Gaze"
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/jackalwere.webp"
```
^statblock
