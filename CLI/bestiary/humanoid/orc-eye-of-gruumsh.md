...
"ac": !!int "16"
"ac_class": "[ring mail](/CLI/items/ring-mail.md), [shield](/CLI/items/shield.md)"
"hp": !!int "45"
"hit_dice": "6d8 + 18"
"stats":
- !!int "16"
...
- "desc": "The orc is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ [resistance](/CLI/spells/resistance.md), [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\
    \n1st level (4 slots): [bless](/CLI/spells/bless.md), [command](/CLI/spells/command.md)\n\
    \n2nd level (2 slots): [augury](/CLI/spells/augury.md), [spiritual weapon](/CLI/spells/spiritual-weapon.md)\
    \ (spear)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/orc-eye-of-gruumsh.webp"
```
^statblock
