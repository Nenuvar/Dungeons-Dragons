...
- "desc": "The gnome's innate spellcasting ability is Intelligence (spell save DC\
    ...
    \ each: [blindness/deafness](/CLI/spells/blindness-deafness.md), [blur](/CLI/spells/blur.md),\
    \ [disguise self](/CLI/spells/disguise-self.md)"
  "name": "Innate Spellcasting"
- "desc": "The gnome has advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/deep-gnome-svirfneblin.webp"
```
^statblock
