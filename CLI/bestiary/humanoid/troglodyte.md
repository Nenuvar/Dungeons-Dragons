...
"cr": "1/4"
"traits":
- "desc": "The troglodyte has advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
    \ checks made to hide."
  "name": "Chameleon Skin"
- "desc": "Any creature other than a troglodyte that starts its turn within 5 feet\
    \ of the troglodyte must succeed on a DC 12 Constitution saving throw or be [poisoned](/CLI/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/troglodyte.webp"
```
^statblock
