...
"cr": "5"
"traits":
- "desc": "The gladiator has advantage on saving throws against being [frightened](/CLI/conditions.md#Frightened)."
  "name": "Brave"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one creature. Hit: 9\
    ...
    \ it must succeed on a DC 15 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Shield Bash"
"reactions":
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/gladiator.webp"
```
^statblock
