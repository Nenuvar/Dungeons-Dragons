...
"cr": "1/4"
"traits":
- "desc": "The grimlock can't use its blindsight while [deafened](/CLI/conditions.md#Deafened)\
    \ and unable to smell."
  "name": "Blind Senses"
- "desc": "The grimlock has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
    \ checks that rely on hearing or smell."
  "name": "Keen Hearing and Smell"
- "desc": "The grimlock has advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/grimlock.webp"
```
^statblock
