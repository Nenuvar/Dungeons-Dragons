...
"ac": !!int "17"
"ac_class": "[half plate armor](/CLI/items/half-plate-armor.md)"
"hp": !!int "49"
"hit_dice": "9d8 + 9"
"stats":
- !!int "15"
...
- "desc": "The githyanki's innate spellcasting ability is Intelligence. It can innately\
    ...
    \ (the hand is invisible)\n\n3/day each: [jump](/CLI/spells/jump.md), [misty\
    \ step](/CLI/spells/misty-step.md), [nondetection](/CLI/spells/nondetection.md)\
    \ (self only)"
...
- "MM"
- "LoX"
"image": "/CLI/bestiary/humanoid/token/githyanki-warrior.webp"
```
^statblock