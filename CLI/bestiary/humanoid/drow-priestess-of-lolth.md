...
Distilled from spider venom and the flora of the Underdark, poison can be found in abundance among the drow, and it plays an important part in their culture and politics. Drow mages concoct a viscid toxin that leaves enemies [unconscious](/CLI/conditions.md#Unconscious). Drow warriors coat their blades and crossbow bolts with this venom, looking forward to the interrogation and torture that follows combat.
...
"ac": !!int "16"
"ac_class": "[scale mail](/CLI/items/scale-mail.md)"
"hp": !!int "71"
"hit_dice": "13d8 + 13"
"stats":
- !!int "10"
...
- "desc": "The drow's spellcasting ability is Charisma (spell save DC 15). She can\
    ...
    \ will: [dancing lights](/CLI/spells/dancing-lights.md)\n\n1/day each: [darkness](/CLI/spells/darkness.md),\
    \ [faerie fire](/CLI/spells/faerie-fire.md), [levitate](/CLI/spells/levitate.md)\
    \ (self only)"
...
- "desc": "The drow is a 10th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ [poison spray](/CLI/spells/poison-spray.md), [resistance](/CLI/spells/resistance.md),\
    \ [spare the dying](/CLI/spells/spare-the-dying.md), [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\
    \n1st level (4 slots): [animal friendship](/CLI/spells/animal-friendship.md),\
    \ [cure wounds](/CLI/spells/cure-wounds.md), [detect poison and disease](/CLI/spells/detect-poison-and-disease.md),\
    \ [ray of sickness](/CLI/spells/ray-of-sickness.md)\n\n2nd level (3 slots):\
    \ [lesser restoration](/CLI/spells/lesser-restoration.md), [protection from poison](/CLI/spells/protection-from-poison.md),\
    \ [web](/CLI/spells/web.md)\n\n3rd level (3 slots): [conjure animals](/CLI/spells/conjure-animals.md)\
    \ (2 [giant spiders](/CLI/bestiary/beast/giant-spider.md)), [dispel magic](/CLI/spells/dispel-magic.md)\n\
    \n4th level (3 slots): [divination](/CLI/spells/divination.md), [freedom of\
    \ movement](/CLI/spells/freedom-of-movement.md)\n\n5th level (2 slots): [insect\
    \ plague](/CLI/spells/insect-plague.md), [mass cure wounds](/CLI/spells/mass-cure-wounds.md)"
  "name": "Spellcasting"
- "desc": "The drow has advantage on saving throws against being [charmed](/CLI/conditions.md#Charmed),\
    \ and magic can't put the drow to sleep."
  "name": "Fey Ancestry"
- "desc": "While in sunlight, the drow has disadvantage on attack rolls, as well as\
    \ on Wisdom ([Perception](/CLI/skills.md#Perception)) checks that rely on sight."
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 5 (1d6\
  ...
  "name": "Scourge"
- "desc": "The drow attempts to magically summon a [yochlol](/CLI/bestiary/fiend/yochlol.md)\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/drow-priestess-of-lolth.webp"
```
^statblock
