...
- "desc": "The priest is a 5th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \n1st level (4 slots): [cure wounds](/CLI/spells/cure-wounds.md), [guiding\
    \ bolt](/CLI/spells/guiding-bolt.md), [sanctuary](/CLI/spells/sanctuary.md)\n\n\
    2nd level (3 slots): [lesser restoration](/CLI/spells/lesser-restoration.md),\
    \ [spiritual weapon](/CLI/spells/spiritual-weapon.md)\n\n3rd level (2 slots):\
    \ [dispel magic](/CLI/spells/dispel-magic.md), [spirit guardians](/CLI/spells/spirit-guardians.md)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/priest.webp"
```
^statblock
