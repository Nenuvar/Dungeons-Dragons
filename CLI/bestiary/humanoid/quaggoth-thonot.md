...
- "desc": "The quaggoth's innate spellcasting ability is Wisdom (spell save DC 11).\
    ...
    \nAt will: [feather fall](/CLI/spells/feather-fall.md), [mage hand](/CLI/spells/mage-hand.md)\
    \ (the hand is invisible)\n\n1/day each: [cure wounds](/CLI/spells/cure-wounds.md),\
    \ [enlarge/reduce](/CLI/spells/enlarge-reduce.md), [heat metal](/CLI/spells/heat-metal.md),\
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/quaggoth-thonot.webp"
```
^statblock
