...
*Source: Monster Manual p. 347, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"cr": "3"
"traits":
- "desc": "The knight has advantage on saving throws against being [frightened](/CLI/conditions.md#Frightened)."
  "name": "Brave"
"actions":
...
- "desc": "For 1 minute, the knight can utter a special command or warning whenever\
    ...
    \ at a time. This effect ends if the knight is [incapacitated](/CLI/conditions.md#Incapacitated)."
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/humanoid/token/knight.webp"
```
^statblock
