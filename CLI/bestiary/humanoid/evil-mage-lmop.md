...
- Evil Mage
---
# [Evil Mage](CLI/bestiary/humanoid/evil-mage-lmop.md)
...
- "desc": "The mage is a 4th-level spellcaster that uses Intelligence as its spellcasting\
    ...
    \ [mage hand](/CLI/spells/mage-hand.md), [shocking grasp](/CLI/spells/shocking-grasp.md)\n\
    \n1st level (4 slots): [charm person](/CLI/spells/charm-person.md), [magic\
    \ missile](/CLI/spells/magic-missile.md)\n\n2nd level (3 slots): [hold person](/CLI/spells/hold-person.md),\
...
"source":
- "LMoP"
"image": "/CLI/bestiary/humanoid/token/evil-mage-lmop.webp"
```
^statblock