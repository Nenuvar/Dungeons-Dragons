...
- "desc": "Once per turn, the hobgoblin can deal an extra 14 (4d6) damage to a creature\
    ...
    \ the hobgoblin that isn't [incapacitated](/CLI/conditions.md#Incapacitated)."
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one creature. Hit: 5\
    ...
    \ on a DC 14 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Shield Bash"
...
- "desc": "For 1 minute, the hobgoblin can utter a special command or warning whenever\
    ...
    \ die at a time. This effect ends if the hobgoblin is [incapacitated](/CLI/conditions.md#Incapacitated)."
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/hobgoblin-warlord.webp"
```
^statblock
