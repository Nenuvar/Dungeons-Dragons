...
- "desc": "The drow is a 10th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ [minor illusion](/CLI/spells/minor-illusion.md), [poison spray](/CLI/spells/poison-spray.md),\
    ...
    \ [shield](/CLI/spells/shield.md), [witch bolt](/CLI/spells/witch-bolt.md)\n\n\
    2nd level (3 slots): [alter self](/CLI/spells/alter-self.md), [misty step](/CLI/spells/misty-step.md),\
    \ [web](/CLI/spells/web.md)\n\n3rd level (3 slots): [fly](/CLI/spells/fly.md),\
    \ [lightning bolt](/CLI/spells/lightning-bolt.md)\n\n4th level (3 slots):\
    \ [Evard's black tentacles](/CLI/spells/evards-black-tentacles.md), [greater invisibility](/CLI/spells/greater-invisibility.md)\n\
    \n5th level (2 slots): [cloudkill](/CLI/spells/cloudkill.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "The drow magically summons a [quasit](/CLI/bestiary/fiend/quasit.md), or\
    \ attempts to summon a [shadow demon](/CLI/bestiary/fiend/shadow-demon.md) with\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/humanoid/token/drow-mage.webp"
```
^statblock
