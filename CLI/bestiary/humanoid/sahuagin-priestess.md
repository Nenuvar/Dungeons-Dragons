...
- "desc": "The sahuagin is a 6th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\n1st level (4 slots): [bless](/CLI/spells/bless.md),\
    \ [detect magic](/CLI/spells/detect-magic.md), [guiding bolt](/CLI/spells/guiding-bolt.md)\n\
    \n2nd level (3 slots): [hold person](/CLI/spells/hold-person.md), [spiritual\
    \ weapon](/CLI/spells/spiritual-weapon.md) (trident)\n\n3rd level (3 slots):\
    \ [mass healing word](/CLI/spells/mass-healing-word.md), [tongues](/CLI/spells/tongues.md)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/sahuagin-priestess.webp"
```
^statblock
