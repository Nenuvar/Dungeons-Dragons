...
Here the half-dragon template has been applied to a human [veteran](/CLI/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](/CLI/items/splint-armor.md) has been replaced with [plate](/CLI/items/plate-armor.md).
...
"source":
- "MM"
"image": "/CLI/bestiary/humanoid/token/half-red-dragon-veteran.webp"
```
^statblock