...
- "desc": "The sphinx is a 12th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \nCantrips (at will): [sacred flame](/CLI/spells/sacred-flame.md), [spare\
    \ the dying](/CLI/spells/spare-the-dying.md), [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\
    \n1st level (4 slots): [command](/CLI/spells/command.md), [detect evil and\
    \ good](/CLI/spells/detect-evil-and-good.md), [detect magic](/CLI/spells/detect-magic.md)\n\
    \n2nd level (3 slots): [lesser restoration](/CLI/spells/lesser-restoration.md),\
    \ [zone of truth](/CLI/spells/zone-of-truth.md)\n\n3rd level (3 slots): [dispel\
    \ magic](/CLI/spells/dispel-magic.md), [tongues](/CLI/spells/tongues.md)\n\n4th\
    \ level (3 slots): [banishment](/CLI/spells/banishment.md), [freedom of movement](/CLI/spells/freedom-of-movement.md)\n\
    \n5th level (2 slots): [flame strike](/CLI/spells/flame-strike.md), [greater\
    \ restoration](/CLI/spells/greater-restoration.md)\n\n6th level (1 slots):\
    \ [heroes' feast](/CLI/spells/heroes-feast.md)"
  "name": "Spellcasting"
- "desc": "The sphinx is immune to any effect that would sense its emotions or read\
    \ its thoughts, as well as any divination spell that it refuses. Wisdom ([Insight](/CLI/skills.md#Insight))\
...
- "desc": "The sphinx emits a magical roar. Each time it roars before finishing a\
    ...
    \ saving throw is [frightened](/CLI/conditions.md#Frightened) for 1 minute. A\
    \ [frightened](/CLI/conditions.md#Frightened) creature can repeat the saving throw\
    \ at the end of each of its turns, ending the effect on itself on a success. \
    \ \n- Second Roar. Each creature that fails a DC 18 Wisdom saving throw is\
    \ [deafened](/CLI/conditions.md#Deafened) and [frightened](/CLI/conditions.md#Frightened)\
    \ for 1 minute. A [frightened](/CLI/conditions.md#Frightened) creature is [paralyzed](/CLI/conditions.md#Paralyzed)\
    ...
    \ thunder damage and is knocked [prone](/CLI/conditions.md#Prone). On a successful\
    \ save, the creature takes half as much damage and isn't knocked [prone](/CLI/conditions.md#Prone).\
    \  "
  "name": "Roar (3/Day)"
"legendary_actions":
...
- "desc": "- The flow of time is altered such that every creature in the lair must\
    ...
    \ choice), but never any younger than 1 year old. A [greater restoration](/CLI/spells/greater-restoration.md)\
    ...
    \ change. A [wish](/CLI/spells/wish.md) spell can return the caster and up to\
    \ seven other creatures designated by the caster to their normal time.  \n- The\
    \ sphinx shifts itself and up to seven other creatures it can see within in its\
    \ lair to another plane of existence. Once outside its lair, the sphinx can't\
    \ use lair actions, but it can return to its lair as a bonus action on its turn,\
    \ taking up to seven creatures with it.  "
  "name": ""
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/androsphinx.webp"
```
^statblock
