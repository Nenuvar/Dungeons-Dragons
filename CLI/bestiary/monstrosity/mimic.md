...
*Source: Monster Manual p. 220, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
    \ adhered to the mimic is also [grappled](/CLI/conditions.md#Grappled) by it (escape\
...
- "desc": "The mimic has advantage on attack rolls against any creature [grappled](/CLI/conditions.md#Grappled)\
    \ by it."
  "name": "Grappler"
"actions":
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/monstrosity/token/mimic.webp"
```
^statblock
