...
"cr": "2"
"traits":
- "desc": "The carrion crawler has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ saving throw or be [poisoned](/CLI/conditions.md#Poisoned) for 1 minute. Until\
    \ this poison ends, the target is [paralyzed](/CLI/conditions.md#Paralyzed). The\
...
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/carrion-crawler.webp"
```
^statblock
