...
- Thri-kreen Mystic
---
# [Thri-kreen Mystic](CLI/bestiary/monstrosity/thri-kreen-mystic-bam.md)
...
- "desc": "The thri-kreen casts one of the following spells, requiring no spell components\
    \ and using Wisdom as the spellcasting ability:\n\nAt will: [levitate](/CLI/spells/levitate.md)\
    \ (self only), [mage hand](/CLI/spells/mage-hand.md) (the hand is invisible)\n\
    \n1/day each: [freedom of movement](/CLI/spells/freedom-of-movement.md) (self\
    \ only), [invisibility](/CLI/spells/invisibility.md) (self only)"
...
- "desc": "The thri-kreen changes the color of its carapace to match the color and\
    \ texture of its surroundings, gaining advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
    \ checks it makes to hide in those surroundings."
  "name": "Chameleon Carapace"
"source":
- "BAM"
- "LoX"
"image": "/CLI/bestiary/monstrosity/token/thri-kreen-mystic-bam.webp"
```
^statblock