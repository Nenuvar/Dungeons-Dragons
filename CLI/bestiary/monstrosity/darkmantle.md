...
*Source: Monster Manual p. 46, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"cr": "1/2"
"traits":
- "desc": "The darkmantle can't use its blindsight while [deafened](/CLI/conditions.md#Deafened)."
  "name": "Echolocation"
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ roll, it attaches by engulfing the target's head, and the target is also [blinded](/CLI/conditions.md#Blinded)\
...
- "desc": "A 15-foot radius of magical darkness extends out from the darkmantle, moves\
    ...
    \ maintains [concentration](/CLI/conditions.md#Concentration), up to 10 minutes\
    \ (as if [concentrating](/CLI/conditions.md#Concentration) on a spell). Darkvision\
    \ can't penetrate this darkness, and no natural light can illuminate it. If any\
    \ of the darkness overlaps with an area of light created by a spell of 2nd level\
    \ or lower, the spell creating the light is dispelled."
  "name": "Darkness Aura (1/Day)"
"source":
- "MM"
- "WBtW"
"image": "/CLI/bestiary/monstrosity/token/darkmantle.webp"
```
^statblock
