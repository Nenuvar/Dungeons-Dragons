...
---
# [Displacer Beast Kitten](CLI/bestiary/monstrosity/displacer-beast-kitten-wbtw.md)
...
- "desc": "The displacer beast projects a magical illusion that makes it appear to\
    ...
    \ [incapacitated](/CLI/conditions.md#Incapacitated) or has a speed of 0."
  "name": "Displacement"
"actions":
...
"source":
- "WBtW"
"image": "/CLI/bestiary/monstrosity/token/displacer-beast-kitten-wbtw.webp"
```
^statblock