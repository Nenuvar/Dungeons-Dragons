...
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one Large or smaller\
    ...
    \ damage. The target is [grappled](/CLI/conditions.md#Grappled) (escape DC 16)\
    \ if the behir isn't already constricting a creature, and the target is [restrained](/CLI/conditions.md#Restrained)\
...
- "desc": "The behir makes one bite attack against a Medium or smaller target it is\
    ...
    \ ends. While swallowed, the target is [blinded](/CLI/conditions.md#Blinded) and\
    \ [restrained](/CLI/conditions.md#Restrained), it has total cover against attacks\
    \ and other effects outside the behir, and it takes 21 (6d6) acid damage at\
    \ the start of each of the behir's turns. A behir can have only one creature swallowed\
    \ at a time.\n\nIf the behir takes 30 damage or more on a single turn from the\
    \ swallowed creature, the behir must succeed on a DC 14 Constitution saving throw\
    \ at the end of that turn or regurgitate the creature, which falls [prone](/CLI/conditions.md#Prone)\
    ...
    \ from the corpse by using 15 feet of movement, exiting [prone](/CLI/conditions.md#Prone)."
  "name": "Swallow"
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/behir.webp"
```
^statblock
