...
- "desc": "The yuan-ti's innate spellcasting ability is Charisma (spell save DC 15).\
    ...
    \nAt will: [animal friendship](/CLI/spells/animal-friendship.md) (snakes only)\n\
    \n1/day: [fear](/CLI/spells/fear.md)\n\n3/day: [suggestion](/CLI/spells/suggestion.md)"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11\
    \ (2d6 + 4) bludgeoning damage, and the target is [grappled](/CLI/conditions.md#Grappled)\
    \ (escape DC 14). Until this grapple ends, the target is [restrained](/CLI/conditions.md#Restrained),\
...
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/yuan-ti-abomination.webp"
```
^statblock
