...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 10\
    ...
    \ or smaller creature, it is [grappled](/CLI/conditions.md#Grappled) (escape DC\
    \ 13). Until this grapple ends, the ankheg can bite only the [grappled](/CLI/conditions.md#Grappled)\
...
- "desc": "The ankheg spits acid in a line that is 30 feet long and 5 feet wide, provided\
    \ that it has no creature [grappled](/CLI/conditions.md#Grappled). Each creature\
    \ in that line must make a DC 13 Dexterity saving throw, taking 10 (3d6) acid\
    \ damage on a failed save, or half as much damage on a successful one."
  "name": "Acid Spray (Recharge 6)"
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/ankheg.webp"
```
^statblock
