...
- "desc": "In the first round of a combat, the doppelganger has advantage on attack\
    \ rolls against any creature it [surprised](/CLI/conditions.md#Surprised)."
  "name": "Ambusher"
...
- "desc": "The doppelganger magically reads the surface thoughts of one creature within\
    ...
    \ as long as the doppelganger's [concentration](/CLI/conditions.md#Concentration)\
    \ isn't broken (as if [concentrating](/CLI/conditions.md#Concentration) on a spell).\
    \ While reading the target's mind, the doppelganger has advantage on Wisdom ([Insight](/CLI/skills.md#Insight))\
    \ and Charisma ([Deception](/CLI/skills.md#Deception), [Intimidation](/CLI/skills.md#Intimidation),\
    \ and [Persuasion](/CLI/skills.md#Persuasion)) checks against the target."
  "name": "Read Thoughts"
"source":
- "MM"
- "LMoP"
"image": "/CLI/bestiary/monstrosity/token/doppelganger.webp"
```
^statblock
