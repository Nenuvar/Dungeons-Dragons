...
- "desc": "Melee Weapon Attack: +7 to hit, reach 50 ft., one creature. Hit:\
    \ The target is [grappled](/CLI/conditions.md#Grappled) (escape DC 15). Until\
    \ the grapple ends, the target is [restrained](/CLI/conditions.md#Restrained)\
  ...
  "name": "Tendril"
- "desc": "The roper pulls each creature [grappled](/CLI/conditions.md#Grappled) by\
    \ it up to 25 feet straight toward it."
  "name": "Reel"
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/roper.webp"
```
^statblock
