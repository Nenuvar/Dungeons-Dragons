...
- "desc": "Melee Weapon Attack: +14 to hit, reach 10 ft., one target. Hit: 22\
    ...
    \ A swallowed creature is [blinded](/CLI/conditions.md#Blinded) and [restrained](/CLI/conditions.md#Restrained),\
    ...
    \ turn or regurgitate all swallowed creatures, which fall [prone](/CLI/conditions.md#Prone)\
    ...
    \ from the corpse by using 20 feet of movement, exiting [prone](/CLI/conditions.md#Prone)."
  "name": "Bite"
...
- "MM"
- "LoX"
"image": "/CLI/bestiary/monstrosity/token/purple-worm.webp"
```
^statblock
