...
- "desc": "The naga is an 11th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \nCantrips (at will): [mending](/CLI/spells/mending.md), [sacred flame](/CLI/spells/sacred-flame.md),\
    \ [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\n1st level (4 slots): [command](/CLI/spells/command.md),\
    \ [cure wounds](/CLI/spells/cure-wounds.md), [shield of faith](/CLI/spells/shield-of-faith.md)\n\
    \n2nd level (3 slots): [calm emotions](/CLI/spells/calm-emotions.md), [hold\
    \ person](/CLI/spells/hold-person.md)\n\n3rd level (3 slots): [bestow curse](/CLI/spells/bestow-curse.md),\
    ...
    \ slots): [flame strike](/CLI/spells/flame-strike.md), [geas](/CLI/spells/geas.md)\n\
    \n6th level (1 slots): [true seeing](/CLI/spells/true-seeing.md)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/guardian-naga.webp"
```
^statblock
