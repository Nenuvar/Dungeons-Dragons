...
*Source: Monster Manual p. 171, The Wild Beyond the Witchlight, Light of Xaryxis. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "If the gorgon moves at least 20 feet straight toward a creature and then\
    ...
    \ 16 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone). If\
    \ the target is [prone](/CLI/conditions.md#Prone), the gorgon can make one attack\
...
- "desc": "The gorgon exhales petrifying gas in a 30-foot cone. Each creature in that\
    ...
    \ target begins to turn to stone and is [restrained](/CLI/conditions.md#Restrained).\
...
- "WBtW"
- "LoX"
"image": "/CLI/bestiary/monstrosity/token/gorgon.webp"
```
^statblock
