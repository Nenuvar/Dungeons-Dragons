...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 3\
    ...
    \ saving throw against being magically [petrified](/CLI/conditions.md#Petrified).\
    \ On a failed save, the creature begins to turn to stone and is [restrained](/CLI/conditions.md#Restrained).\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/monstrosity/token/cockatrice.webp"
```
^statblock
