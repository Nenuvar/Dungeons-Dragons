...
- Ssurran Defiler
---
# [Ssurran Defiler](CLI/bestiary/monstrosity/ssurran-defiler-bam.md)
...
- "desc": "The ssurran casts one of the following spells, requiring no spell components\
    ...
    \ (the hand is invisible)\n\n1/day: [invisibility](/CLI/spells/invisibility.md)\
    \ (self only)"
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/monstrosity/token/ssurran-defiler-bam.webp"
```
^statblock