...
- "desc": "The sphinx is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ [shield](/CLI/spells/shield.md)\n\n2nd level (3 slots): [darkness](/CLI/spells/darkness.md),\
    \ [locate object](/CLI/spells/locate-object.md), [suggestion](/CLI/spells/suggestion.md)\n\
    \n3rd level (3 slots): [dispel magic](/CLI/spells/dispel-magic.md), [remove\
    \ curse](/CLI/spells/remove-curse.md), [tongues](/CLI/spells/tongues.md)\n\n4th\
    \ level (3 slots): [banishment](/CLI/spells/banishment.md), [greater invisibility](/CLI/spells/greater-invisibility.md)\n\
    \n5th level (1 slots): [legend lore](/CLI/spells/legend-lore.md)"
  "name": "Spellcasting"
...
"source":
- "MM"
"image": "/CLI/bestiary/monstrosity/token/gynosphinx.webp"
```
^statblock
