...
"cr": "3"
"traits":
- "desc": "The hook horror can't use its blindsight while [deafened](/CLI/conditions.md#Deafened)."
  "name": "Echolocation"
- "desc": "The hook horror has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "MM"
- "LoX"
"image": "/CLI/bestiary/monstrosity/token/hook-horror.webp"
```
^statblock
