...
*Source: Monster Manual p. 148, Lost Mine of Phandelver, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (2d4\
    ...
    \ it must succeed on a DC 10 Constitution saving throw or be [paralyzed](/CLI/conditions.md#Paralyzed)\
...
- "LMoP"
- "WBtW"
"image": "/CLI/bestiary/undead/token/ghoul.webp"
```
^statblock
