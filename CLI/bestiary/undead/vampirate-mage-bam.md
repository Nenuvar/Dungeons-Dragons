...
- Vampirate Mage
---
# [Vampirate Mage](CLI/bestiary/undead/vampirate-mage-bam.md)
...
- "desc": "The mage casts one of the following spells, using Charisma as the spellcasting\
    ...
    \ [message](/CLI/spells/message.md)\n\n1/day: [darkness](/CLI/spells/darkness.md),\
    \ [dimension door](/CLI/spells/dimension-door.md), [fly](/CLI/spells/fly.md),\
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/undead/token/vampirate-mage-bam.webp"
```
^statblock