...
A lich must periodically feed souls to its phylactery to sustain the magic preserving its body and consciousness. It does this using the [imprisonment](/CLI/spells/imprisonment.md) spell. Instead of choosing one of the normal options of the spell, the lich uses the spell to magically trap the target's body and soul inside its phylactery. The phylactery must be on the same plane as the lich for the spell to work. A lich's phylactery can hold only one creature at a time, and a [dispel magic](/CLI/spells/dispel-magic.md) cast as a 9th-level spell upon the phylactery releases any creature imprisoned within it. A creature imprisoned in the phylactery for 24 hours is consumed and destroyed utterly, whereupon nothing short of divine intervention can restore it to life.
...
- "desc": "The lich is an 18th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \n1st level (4 slots): [detect magic](/CLI/spells/detect-magic.md), [magic\
    \ missile](/CLI/spells/magic-missile.md), [shield](/CLI/spells/shield.md), [thunderwave](/CLI/spells/thunderwave.md)\n\
    \n2nd level (3 slots): [detect thoughts](/CLI/spells/detect-thoughts.md),\
    \ [invisibility](/CLI/spells/invisibility.md), [Melf's acid arrow](/CLI/spells/melfs-acid-arrow.md),\
    \ [mirror image](/CLI/spells/mirror-image.md)\n\n3rd level (3 slots): [animate\
    \ dead](/CLI/spells/animate-dead.md), [counterspell](/CLI/spells/counterspell.md),\
    \ [dispel magic](/CLI/spells/dispel-magic.md), [fireball](/CLI/spells/fireball.md)\n\
    \n4th level (3 slots): [blight](/CLI/spells/blight.md), [dimension door](/CLI/spells/dimension-door.md)\n\
    \n5th level (3 slots): [cloudkill](/CLI/spells/cloudkill.md), [scrying](/CLI/spells/scrying.md)\n\
    \n6th level (1 slots): [disintegrate](/CLI/spells/disintegrate.md), [globe\
    \ of invulnerability](/CLI/spells/globe-of-invulnerability.md)\n\n7th level\
    \ (1 slots): [finger of death](/CLI/spells/finger-of-death.md), [plane shift](/CLI/spells/plane-shift.md)\n\
    \n8th level (1 slots): [dominate monster](/CLI/spells/dominate-monster.md),\
...
- "desc": "Melee Spell Attack: +12 to hit, reach 5 ft., one creature. Hit: 10\
    ...
    \ throw or be [paralyzed](/CLI/conditions.md#Paralyzed) for 1 minute. The target\
...
- "desc": "The lich fixes its gaze on one creature it can see within 10 feet of it.\
    ...
    \ become [frightened](/CLI/conditions.md#Frightened) for 1 minute. The [frightened](/CLI/conditions.md#Frightened)\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/lich.webp"
```
^statblock