...
"condition_immunities": "[exhaustion](/CLI/conditions.md#Exhaustion), [frightened](/CLI/conditions.md#Frightened),\
...
- "desc": "The death knight is a 19th-level spellcaster. Its spellcasting ability\
    ...
    \ [compelled duel](/CLI/spells/compelled-duel.md), [searing smite](/CLI/spells/searing-smite.md)\n\
    \n2nd level (3 slots): [hold person](/CLI/spells/hold-person.md), [magic weapon](/CLI/spells/magic-weapon.md)\n\
    \n3rd level (3 slots): [dispel magic](/CLI/spells/dispel-magic.md), [elemental\
    \ weapon](/CLI/spells/elemental-weapon.md)\n\n4th level (3 slots): [banishment](/CLI/spells/banishment.md),\
    \ [staggering smite](/CLI/spells/staggering-smite.md)\n\n5th level (2 slots):\
    \ [destructive wave](/CLI/spells/destructive-wave.md) (necrotic)"
  "name": "Spellcasting"
- "desc": "The death knight has advantage on saving throws against spells and other\
    \ magical effects."
  "name": "Magic Resistance"
- "desc": "Unless the death knight is [incapacitated](/CLI/conditions.md#Incapacitated),\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/death-knight.webp"
```
^statblock