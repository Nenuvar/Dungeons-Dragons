...
- "desc": "The mummy targets one creature it can see within 60 feet of it. If the\
    ...
    \ this magic or become [frightened](/CLI/conditions.md#Frightened) until the end\
    \ of the mummy's next turn. If the target fails the saving throw by 5 or more,\
    \ it is also [paralyzed](/CLI/conditions.md#Paralyzed) for the same duration.\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/mummy.webp"
```
^statblock
