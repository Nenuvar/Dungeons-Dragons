...
- Avatar of Death (DMG)
---
# [Avatar of Death (DMG)](CLI/bestiary/undead/avatar-of-death-dmg.md)
*Source: Dungeon Master's Guide p. 164. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  

Summoned by the "Skull" card from the [Deck of Many Things](/CLI/items/deck-of-many-things.md).
...
"source":
- "DMG"
"image": "/CLI/bestiary/undead/token/avatar-of-death.webp"
```
^statblock