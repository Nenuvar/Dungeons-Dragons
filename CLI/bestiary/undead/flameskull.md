...
A flameskull's shattered fragments reform unless they are splashed with holy water or subjected to a [dispel magic](/CLI/spells/dispel-magic.md) or [remove curse](/CLI/spells/remove-curse.md) spell. If it can no longer fulfill its intended purpose, the re-formed flameskull is beholden to no one and becomes autonomous.
...
- "desc": "The flameskull is a 5th-level spellcaster. Its spellcasting ability is\
    ...
    \n1st level (3 slots): [magic missile](/CLI/spells/magic-missile.md), [shield](/CLI/spells/shield.md)\n\
    \n2nd level (2 slots): [blur](/CLI/spells/blur.md), [flaming sphere](/CLI/spells/flaming-sphere.md)\n\
    \n3rd level (1 slots): [fireball](/CLI/spells/fireball.md)"
  "name": "Spellcasting"
...
- "desc": "If the flameskull is destroyed, it regains all its hit points in 1 hour\
    \ unless holy water is sprinkled on its remains or a [dispel magic](/CLI/spells/dispel-magic.md)\
    \ or [remove curse](/CLI/spells/remove-curse.md) spell is cast on them."
  "name": "Rejuvenation"
"actions":
...
- "LMoP"
- "WBtW"
"image": "/CLI/bestiary/undead/token/flameskull.webp"
```
^statblock
