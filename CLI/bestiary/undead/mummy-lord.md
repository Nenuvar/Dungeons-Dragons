...
- "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ the following cleric spells prepared:\n\nCantrips (at will): [sacred flame](/CLI/spells/sacred-flame.md),\
    \ [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\n1st level (4 slots): [command](/CLI/spells/command.md),\
    \ [guiding bolt](/CLI/spells/guiding-bolt.md), [shield of faith](/CLI/spells/shield-of-faith.md)\n\
    \n2nd level (3 slots): [hold person](/CLI/spells/hold-person.md), [silence](/CLI/spells/silence.md),\
    \ [spiritual weapon](/CLI/spells/spiritual-weapon.md)\n\n3rd level (3 slots):\
    \ [animate dead](/CLI/spells/animate-dead.md), [dispel magic](/CLI/spells/dispel-magic.md)\n\
    \n4th level (3 slots): [divination](/CLI/spells/divination.md), [guardian\
    \ of faith](/CLI/spells/guardian-of-faith.md)\n\n5th level (2 slots): [contagion](/CLI/spells/contagion.md),\
    \ [insect plague](/CLI/spells/insect-plague.md)\n\n6th level (1 slots): [harm](/CLI/spells/harm.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 14\
    ...
    \ to dust. The curse lasts until removed by the [remove curse](/CLI/spells/remove-curse.md)\
...
- "desc": "The mummy lord targets one creature it can see within 60 feet of it. If\
    ...
    \ throw against this magic or become [frightened](/CLI/conditions.md#Frightened)\
    \ until the end of the mummy's next turn. If the target fails the saving throw\
    \ by 5 or more, it is also [paralyzed](/CLI/conditions.md#Paralyzed) for the same\
...
- "desc": "Blinding dust and sand swirls magically around the mummy lord. Each creature\
    ...
    \ throw or be [blinded](/CLI/conditions.md#Blinded) until the end of the creature's\
    \ next turn."
  "name": "Blinding Dust"
- "desc": "The mummy lord utters a blasphemous word. Each non-undead creature within\
    ...
    \ a DC 16 Constitution saving throw or be [stunned](/CLI/conditions.md#Stunned)\
...
- "desc": "The mummy lord magically transforms into a whirlwind of sand, moves up\
    ...
    \ lord is immune to all damage, and it can't be [grappled](/CLI/conditions.md#Grappled),\
    \ [petrified](/CLI/conditions.md#Petrified), knocked [prone](/CLI/conditions.md#Prone),\
    \ [restrained](/CLI/conditions.md#Restrained), or [stunned](/CLI/conditions.md#Stunned).\
...
- "desc": "- Food instantly molders and water instantly evaporates when brought into\
    ...
    \ instance.  \n- [Divination](/CLI/spells/divination.md) spells cast within the\
    \ lair by creatures other than the mummy lord have a 25 percent chance to provide\
    \ misleading results, as determined by the DM. If a [divination](/CLI/spells/divination.md)\
    ...
    \ on all saving throws. The curse lasts until removed by a [remove curse](/CLI/spells/remove-curse.md)\
    \ spell or other magic.  "
  "name": ""
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/mummy-lord.webp"
```
^statblock
