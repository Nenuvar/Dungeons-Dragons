...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ weapon made of wood is driven into its heart while it is [incapacitated](/CLI/conditions.md#Incapacitated)\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/vampire-spawn.webp"
```
^statblock
