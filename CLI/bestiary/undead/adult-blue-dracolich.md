...
The dracolich can't be [charmed](/CLI/conditions.md#Charmed), [frightened](/CLI/conditions.md#Frightened), [paralyzed](/CLI/conditions.md#Paralyzed), or [poisoned](/CLI/conditions.md#Poisoned). It also doesn't suffer from [exhaustion](/CLI/conditions.md#Exhaustion).
...
- "desc": "Each creature of the dracolich's choice that is within 120 feet of the\
    ...
    \ [frightened](/CLI/conditions.md#Frightened) for 1 minute. A creature can repeat\
...
"legendary_actions":
- "desc": "The dracolich makes a Wisdom ([Perception](/CLI/skills.md#Perception))\
    \ check."
  "name": "Detect"
...
- "desc": "The dracolich beats its tattered wings. Each creature within 10 feet of\
    ...
    \ + 7) bludgeoning damage and be knocked [prone](/CLI/conditions.md#Prone). After\
    \ beating its wings this way, the dracolich can fly up to half its flying speed."
...
- "desc": "- Part of the ceiling collapses above one creature that the dragon can\
    ...
    \ throw or take 10 (3d6) bludgeoning damage and be knocked [prone](/CLI/conditions.md#Prone)\
    \ and buried. The buried target is [restrained](/CLI/conditions.md#Restrained)\
    ...
    \ cloud must succeed on a DC 15 Constitution saving throw or be [blinded](/CLI/conditions.md#Blinded)\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](/CLI/bestiary/dragon/adult-blue-dragon.md)\
    \ or [ancient](/CLI/bestiary/dragon/ancient-blue-dragon.md)) blue dragon can use\
    \ one or both of the following additional lair actions while in its lair:\n\n\
    ...
    \ to the bottom of the pit, taking 7 (2d6) bludgeoning damage and landing [prone](/CLI/conditions.md#Prone).\
...
- "desc": "- Thunderstorms rage within 6 miles of the lair.  \n- Dust devils scour\
    ...
    \ Wisdom ([Perception](/CLI/skills.md#Perception)) check. Otherwise, the first\
    \ creature to step on the thin crust covering the sinkhole must succeed on a DC\
    \ 15 Dexterity saving throw or fall 1d6 × 10 feet into the sinkhole.  "
  "name": ""
...
- "desc": "Any of these effects might appear in the area around a blue dragon's lair,\
    ...
    \ attempt a DC 15 Intelligence ([Investigation](/CLI/skills.md#Investigation))\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/adult-blue-dracolich.webp"
```
^statblock
