...
> 
> The game statistics of a player character transformed into a vampire spawn and then a vampire don't change, except that the character's Strength, Dexterity, and Constitution scores become 18 if they aren't higher. In addition, the character gains the vampire's damage resistances, [darkvision](/CLI/senses.md#Darkvision), traits, and actions. Attack and damage rolls for the vampire's attacks are based on Strength.
> 
> The save DC for Charm is 8 + the vampire's proficiency bonus + the vampire's Charisma modifier. The character's alignment becomes lawful evil, and the DM might take control of the character until the vampirism is reversed with a [wish](/CLI/spells/wish.md) spell or the character is killed and brought back to life.
...
- "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ wizard spells prepared:\n\nCantrips (at will): [mage hand](/CLI/spells/mage-hand.md),\
    \ [prestidigitation](/CLI/spells/prestidigitation.md), [ray of frost](/CLI/spells/ray-of-frost.md)\n\
    \n1st level (4 slots): [comprehend languages](/CLI/spells/comprehend-languages.md),\
    \ [fog cloud](/CLI/spells/fog-cloud.md), [sleep](/CLI/spells/sleep.md)\n\n2nd\
    \ level (3 slots): [detect thoughts](/CLI/spells/detect-thoughts.md), [gust\
    \ of wind](/CLI/spells/gust-of-wind.md), [mirror image](/CLI/spells/mirror-image.md)\n\
    \n3rd level (3 slots): [animate dead](/CLI/spells/animate-dead.md), [bestow\
    \ curse](/CLI/spells/bestow-curse.md), [nondetection](/CLI/spells/nondetection.md)\n\
    \n4th level (3 slots): [blight](/CLI/spells/blight.md), [greater invisibility](/CLI/spells/greater-invisibility.md)\n\
    \n5th level (1 slots): [dominate person](/CLI/spells/dominate-person.md)"
  "name": "Spellcasting"
...
- "desc": "When it drops to 0 hit points outside its resting place, the vampire transforms\
    \ into a cloud of mist (as in the Shapechanger trait) instead of falling [unconscious](/CLI/conditions.md#Unconscious),\
    ...
    \ then [paralyzed](/CLI/conditions.md#Paralyzed) until it regains at least 1 hit\
    \ point. After spending 1 hour in its resting place with 0 hit points, it regains\
    \ 1 hit point."
  "name": "Misty Escape"
...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ into the vampire's heart while the vampire is [incapacitated](/CLI/conditions.md#Incapacitated)\
    \ in its resting place, the vampire is [paralyzed](/CLI/conditions.md#Paralyzed)\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
    \ or a creature that is [grappled](/CLI/conditions.md#Grappled) by the vampire,\
    \ [incapacitated](/CLI/conditions.md#Incapacitated), or [restrained](/CLI/conditions.md#Restrained).\
    ...
    \ the ground rises the following night as a [vampire spawn](/CLI/bestiary/undead/vampire-spawn.md)\
...
- "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
    ...
    \ throw against this magic or be [charmed](/CLI/conditions.md#Charmed) by the\
    \ vampire. The [charmed](/CLI/conditions.md#Charmed) target regards the vampire\
    ...
    \ the effect."
  "name": "Charm"
- "desc": "The vampire magically calls 2d4 swarms of [bats](/CLI/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](/CLI/bestiary/beast/swarm-of-rats.md), provided that the sun isn't\
    \ up. While outdoors, the vampire can call 3d6 [wolves](/CLI/bestiary/beast/wolf.md)\
...
"source":
- "MM"
"image": "/CLI/bestiary/undead/token/vampire-spellcaster.webp"
```
^statblock
