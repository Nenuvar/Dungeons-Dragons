...
- "desc": "If the mammoth moves at least 20 feet straight toward a creature and then\
    ...
    \ 18 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone). If\
    \ the target is [prone](/CLI/conditions.md#Prone), the mammoth can make one stomp\
...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 25\
  ...
  "name": "Gore"
- "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one [prone](/CLI/conditions.md#Prone)\
    \ creature. Hit: 29 (4d10 + 7) bludgeoning damage."
  "name": "Stomp"
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/mammoth.webp"
```
^statblock
