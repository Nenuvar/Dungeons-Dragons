...
"cr": "1/4"
"traits":
- "desc": "The panther has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "If the panther moves at least 20 feet straight toward a creature and then\
    ...
    \ the target is [prone](/CLI/conditions.md#Prone), the panther can make one bite\
...
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/panther.webp"
```
^statblock
