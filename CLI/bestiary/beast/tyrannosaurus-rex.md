...
- "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit: 33\
    ...
    \ it is [grappled](/CLI/conditions.md#Grappled) (escape DC 17). Until this grapple\
    \ ends, the target is [restrained](/CLI/conditions.md#Restrained), and the tyrannosaurus\
...
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/tyrannosaurus-rex.webp"
```
^statblock
