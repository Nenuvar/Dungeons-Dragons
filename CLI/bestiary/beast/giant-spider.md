...
- "desc": "Ranged Weapon Attack: +5 to hit, range 30/60 ft., one creature. Hit:\
    \ The target is [restrained](/CLI/conditions.md#Restrained) by webbing. As an\
    \ action, the [restrained](/CLI/conditions.md#Restrained) target can make a DC\
...
- "MM"
- "LMoP"
"image": "/CLI/bestiary/beast/token/giant-spider.webp"
```
^statblock
