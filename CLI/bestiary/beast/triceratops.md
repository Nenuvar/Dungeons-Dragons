...
- "desc": "If the triceratops moves at least 20 feet straight toward a creature and\
    ...
    \ If the target is [prone](/CLI/conditions.md#Prone), the triceratops can make\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 24\
  ...
  "name": "Gore"
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one [prone](/CLI/conditions.md#Prone)\
    \ creature. Hit: 22 (3d10 + 6) bludgeoning damage"
  "name": "Stomp"
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/triceratops.webp"
```
^statblock
