...
"cr": "1"
"traits":
- "desc": "The lion has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "If the lion moves at least 20 feet straight toward a creature and then\
    ...
    \ the target is [prone](/CLI/conditions.md#Prone), the lion can make one bite\
...
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/lion.webp"
```
^statblock
