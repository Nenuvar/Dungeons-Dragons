...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ the target to 0 hit points, the target is stable but [poisoned](/CLI/conditions.md#Poisoned)\
    \ for 1 hour, even after regaining hit points, and is [paralyzed](/CLI/conditions.md#Paralyzed)\
    \ while [poisoned](/CLI/conditions.md#Poisoned) in this way."
  "name": "Bite"
"source":
- "MM"
"image": "/CLI/bestiary/beast/token/giant-centipede.webp"
```
^statblock
