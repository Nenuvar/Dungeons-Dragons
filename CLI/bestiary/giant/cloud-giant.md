...
- "desc": "The giant's innate spellcasting ability is Charisma. It can innately cast\
    ...
    \ magic](/CLI/spells/detect-magic.md), [fog cloud](/CLI/spells/fog-cloud.md),\
    \ [light](/CLI/spells/light.md)\n\n1/day each: [control weather](/CLI/spells/control-weather.md),\
    \ [gaseous form](/CLI/spells/gaseous-form.md)\n\n3/day each: [feather fall](/CLI/spells/feather-fall.md),\
    \ [fly](/CLI/spells/fly.md), [misty step](/CLI/spells/misty-step.md), [telekinesis](/CLI/spells/telekinesis.md)"
  "name": "Innate Spellcasting"
- "desc": "The giant has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
"source":
- "MM"
"image": "/CLI/bestiary/giant/token/cloud-giant.webp"
```
^statblock
