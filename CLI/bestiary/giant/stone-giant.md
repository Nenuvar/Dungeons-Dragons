...
"cr": "7"
"traits":
- "desc": "The giant has advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth))\
...
- "desc": "Ranged Weapon Attack: +9 to hit, range 60/240 ft., one target. Hit:\
    ...
    \ on a DC 17 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Rock"
"reactions":
...
"source":
- "MM"
"image": "/CLI/bestiary/giant/token/stone-giant.webp"
```
^statblock
