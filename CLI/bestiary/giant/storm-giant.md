...
- "desc": "The giant's innate spellcasting ability is Charisma (spell save DC 17).\
    ...
    \nAt will: [detect magic](/CLI/spells/detect-magic.md), [feather fall](/CLI/spells/feather-fall.md),\
    \ [levitate](/CLI/spells/levitate.md), [light](/CLI/spells/light.md)\n\n3/day\
    \ each: [control weather](/CLI/spells/control-weather.md), [water breathing](/CLI/spells/water-breathing.md)"
...
"source":
- "MM"
"image": "/CLI/bestiary/giant/token/storm-giant.webp"
```
^statblock
