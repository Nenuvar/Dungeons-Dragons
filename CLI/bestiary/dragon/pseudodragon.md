...
"cr": "1/4"
"traits":
- "desc": "The pseudodragon has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 4\
    ...
    \ saving throw or become [poisoned](/CLI/conditions.md#Poisoned) for 1 hour. If\
    \ the saving throw fails by 5 or more, the target falls [unconscious](/CLI/conditions.md#Unconscious)\
    \ for the same duration, or until it takes damage or another creature uses an\
    \ action to shake it awake."
  "name": "Sting"
"source":
- "MM"
"image": "/CLI/bestiary/dragon/token/pseudodragon.webp"
```
^statblock
