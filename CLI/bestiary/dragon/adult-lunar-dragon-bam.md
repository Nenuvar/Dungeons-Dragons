...
- Adult Lunar Dragon
---
# [Adult Lunar Dragon](CLI/bestiary/dragon/adult-lunar-dragon-bam.md)
...
"bonus_actions":
- "desc": "The dragon becomes partially incorporeal for as long as it maintains [concentration](/CLI/conditions.md#Concentration)\
    \ on the effect (as if [concentrating](/CLI/conditions.md#Concentration) on a\
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/dragon/token/adult-lunar-dragon-bam.webp"
```
^statblock