...
---
# [Ancient Silver Dragon](CLI/bestiary/dragon/ancient-silver-dragon.md)
...
- "desc": "Each creature of the dragon's choice that is within 120 feet of the dragon\
    \ and aware of it must succeed on a DC 21 Wisdom saving throw or become [frightened](/CLI/conditions.md#Frightened)\
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Cold Breath.\
    ...
    \ in that area must succeed on a DC 24 Constitution saving throw or be [paralyzed](/CLI/conditions.md#Paralyzed)\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
...
- "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
  ...
  "name": ""
- "desc": "- The dragon creates fog as if it had cast the [fog cloud](/CLI/spells/fog-cloud.md)\
  ...
  "name": ""
- "desc": "At your discretion, a legendary ([adult](/CLI/bestiary/dragon/adult-silver-dragon.md)\
    \ or [ancient](/CLI/bestiary/dragon/ancient-silver-dragon.md)) silver dragon can\
    \ use the following additional lair action while in its lair:\n\n- Icy Grip.\
    ...
    \ DC 15 Constitution saving throw or be [restrained](/CLI/conditions.md#Restrained)\
...
- "desc": "- Once per day, the dragon can alter the weather in a 6-mile radius centered\
    ...
    \ identical to the [control weather](/CLI/spells/control-weather.md) spell.  \n\
    - Within 1 mile of the lair, winds buoy non-evil creatures that fall due to no\
    \ act of the dragon's or its allies. Such creatures descend at a rate of 60 feet\
    \ per round and take no falling damage.  \n- Given days or longer to work, the\
    \ dragon can make clouds and fog within its lair as solid as stone, forming structures\
    \ and other objects as it wishes.  "
  "name": ""
...
"source":
- "MM"
"image": "/CLI/bestiary/dragon/token/ancient-silver-dragon.webp"
```
^statblock
