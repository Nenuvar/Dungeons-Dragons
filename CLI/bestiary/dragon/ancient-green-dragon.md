...
- "desc": "Each creature of the dragon's choice that is within 120 feet of the dragon\
    \ and aware of it must succeed on a DC 19 Wisdom saving throw or become [frightened](/CLI/conditions.md#Frightened)\
...
- "desc": "- Grasping roots and vines erupt in a 20-foot radius centered on a point\
    ...
    \ saving throw or be [restrained](/CLI/conditions.md#Restrained) by the roots\
    \ and vines. A creature can be freed if it or another creature takes an action\
    \ to make a DC 15 Strength check and succeeds. The roots and vines wilt away when\
    \ the dragon uses this lair action again or when the dragon dies.  \n- A wall\
    \ of tangled brush bristling with thorns springs into existence on a solid surface\
    \ within 120 feet of the dragon. The wall is up to 60 feet long, 10 feet high,\
    \ and 5 feet thick, and it blocks line of sight. When the wall appears, each creature\
    \ in its area must make a DC 15 Dexterity saving throw. A creature that fails\
    \ the save takes 18 (4d8) piercing damage and is pushed 5 feet out of the wall's\
    \ space, appearing on whichever side of the wall it wants. A creature can move\
    \ through the wall, albeit slowly and painfully. For every 1 foot a creature travels\
    \ through the wall, it must spend 4 feet of movement. Furthermore, a creature\
    ...
    \ of it. The creature must succeed on a DC 15 Wisdom saving throw or be [charmed](/CLI/conditions.md#Charmed)\
    \ by the dragon until initiative count 20 on the next round.  "
  "name": ""
- "desc": "At your discretion, a legendary ([adult](/CLI/bestiary/dragon/adult-green-dragon.md)\
    \ or [ancient](/CLI/bestiary/dragon/ancient-green-dragon.md)) green dragon can\
    ...
    \ to animate up to three Humanoid corpses, which become [zombies](/CLI/bestiary/undead/zombie.md).\
    ...
    \ on a DC 15 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone).\
    \  "
...
"source":
- "MM"
"image": "/CLI/bestiary/dragon/token/ancient-green-dragon.webp"
```
^statblock
