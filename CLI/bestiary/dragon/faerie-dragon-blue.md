...
- "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \ [mage hand](/CLI/spells/mage-hand.md), [major image](/CLI/spells/major-image.md),\
    \ [minor illusion](/CLI/spells/minor-illusion.md), [mirror image](/CLI/spells/mirror-image.md),\
...
"source":
- "MM"
"image": "/CLI/bestiary/dragon/token/faerie-dragon-blue.webp"
```
^statblock
