...
*Source: Monster Manual p. 294, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"condition_immunities": "[charmed](/CLI/conditions.md#Charmed), [paralyzed](/CLI/conditions.md#Paralyzed),\
...
- "desc": "The unicorn's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \nAt will: [detect evil and good](/CLI/spells/detect-evil-and-good.md), [druidcraft](/CLI/spells/druidcraft.md),\
    \ [pass without trace](/CLI/spells/pass-without-trace.md)\n\n1/day each: [calm\
    \ emotions](/CLI/spells/calm-emotions.md), [dispel evil and good](/CLI/spells/dispel-evil-and-good.md),\
...
- "desc": "- Open flames of a non magical nature are extinguished within the unicorn's\
    ...
    \ have advantage on all Dexterity ([Stealth](/CLI/skills.md#Stealth)) checks made\
    \ to hide.  \n- When a good-aligned creature casts a spell or uses a magical effect\
    \ that causes another good-aligned creature to regain hit points, the target regains\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/celestial/token/unicorn.webp"
```
^statblock
