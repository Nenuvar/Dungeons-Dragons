...
- "desc": "The couatl's spellcasting ability is Charisma (spell save DC 14). It can\
    ...
    \ will: [detect evil and good](/CLI/spells/detect-evil-and-good.md), [detect\
    \ magic](/CLI/spells/detect-magic.md), [detect thoughts](/CLI/spells/detect-thoughts.md)\n\
    \n1/day each: [dream](/CLI/spells/dream.md), [greater restoration](/CLI/spells/greater-restoration.md),\
    \ [scrying](/CLI/spells/scrying.md)\n\n3/day each: [bless](/CLI/spells/bless.md),\
    \ [create food and water](/CLI/spells/create-food-and-water.md), [cure wounds](/CLI/spells/cure-wounds.md),\
    \ [lesser restoration](/CLI/spells/lesser-restoration.md), [protection from poison](/CLI/spells/protection-from-poison.md),\
    \ [sanctuary](/CLI/spells/sanctuary.md), [shield](/CLI/spells/shield.md)"
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one creature. Hit: 8\
    ...
    \ saving throw or be [poisoned](/CLI/conditions.md#Poisoned) for 24 hours. Until\
    \ this poison ends, the target is [unconscious](/CLI/conditions.md#Unconscious).\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one Medium or smaller\
    \ creature. Hit: 10 (2d6 + 3) bludgeoning damage, and the target is [grappled](/CLI/conditions.md#Grappled)\
    \ (escape DC 15). Until this grapple ends, the target is [restrained](/CLI/conditions.md#Restrained),\
...
"source":
- "MM"
"image": "/CLI/bestiary/celestial/token/couatl.webp"
```
^statblock
