...
"condition_immunities": "[charmed](/CLI/conditions.md#Charmed), [exhaustion](/CLI/conditions.md#Exhaustion),\
  \ [frightened](/CLI/conditions.md#Frightened), [poisoned](/CLI/conditions.md#Poisoned)"
...
- "desc": "The solar's spellcasting ability is Charisma (spell save DC 25). It can\
    ...
    \ will: [detect evil and good](/CLI/spells/detect-evil-and-good.md), [invisibility](/CLI/spells/invisibility.md)\
    \ (self only)\n\n1/day each: [commune](/CLI/spells/commune.md), [control weather](/CLI/spells/control-weather.md)\n\
    \n3/day each: [blade barrier](/CLI/spells/blade-barrier.md), [dispel evil\
    \ and good](/CLI/spells/dispel-evil-and-good.md), [resurrection](/CLI/spells/resurrection.md)"
...
- "desc": "The solar targets one creature it can see within 30 feet of it. If the\
    ...
    \ or be [blinded](/CLI/conditions.md#Blinded) until magic such as the [lesser\
    \ restoration](/CLI/spells/lesser-restoration.md) spell removes the blindness."
  "name": "Blinding Gaze (Costs 3 Actions)"
"source":
- "MM"
"image": "/CLI/bestiary/celestial/token/solar.webp"
```
^statblock