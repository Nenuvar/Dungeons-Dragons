...
- "desc": "The empyrean's innate spellcasting ability is Charisma (spell save DC 23,\
    ...
    \ requiring no material components:\n\nAt will: [greater restoration](/CLI/spells/greater-restoration.md),\
    \ [pass without trace](/CLI/spells/pass-without-trace.md), [water breathing](/CLI/spells/water-breathing.md),\
    \ [water walk](/CLI/spells/water-walk.md)\n\n1/day each: [commune](/CLI/spells/commune.md),\
    \ [dispel evil and good](/CLI/spells/dispel-evil-and-good.md), [earthquake](/CLI/spells/earthquake.md),\
    \ [fire storm](/CLI/spells/fire-storm.md), [plane shift](/CLI/spells/plane-shift.md)\
    \ (self only)"
...
- "desc": "Melee Weapon Attack: +17 to hit, reach 10 ft., one target. Hit: 31\
    ...
    \ on a DC 15 Constitution saving throw or be [stunned](/CLI/conditions.md#Stunned)\
...
- "desc": "The empyrean bolsters all nonhostile creatures within 120 feet of it until\
    \ the end of its next turn. Bolstered creatures can't be [charmed](/CLI/conditions.md#Charmed)\
    \ or [frightened](/CLI/conditions.md#Frightened), and they gain advantage on ability\
    \ checks and saving throws until the end of the empyrean's next turn."
  "name": "Bolster"
- "desc": "The empyrean strikes the ground with its maul, triggering an earth tremor.\
    ...
    \ on a DC 25 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Trembling Strike (Costs 2 Actions)"
"source":
- "MM"
"image": "/CLI/bestiary/celestial/token/empyrean.webp"
```
^statblock