...
---
# [Starlight Apparition](CLI/bestiary/celestial/starlight-apparition-bam.md)
...
- "desc": "Melee or Ranged Spell Attack: +6 to hit, reach 5 ft. or range 120 ft.,\
    ...
    \ it must succeed on a DC 14 Wisdom saving throw or be [blinded](/CLI/conditions.md#Blinded)\
...
- "desc": "One Humanoid that the apparition can see within 5 feet of itself must succeed\
    ...
    \ then disappears, and the target is [incapacitated](/CLI/conditions.md#Incapacitated)\
    ...
    \ Charisma, and immunity to being [charmed](/CLI/conditions.md#Charmed) and [frightened](/CLI/conditions.md#Frightened).\
    ...
    \ an effect like the [dispel evil and good](/CLI/spells/dispel-evil-and-good.md)\
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/celestial/token/starlight-apparition-bam.webp"
```
^statblock