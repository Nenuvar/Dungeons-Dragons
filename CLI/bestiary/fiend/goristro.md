...
- "desc": "If the goristro moves at least 15 feet straight toward a target and then\
    ...
    \ saving throw or be pushed up to 20 feet away and knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Charge"
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 23\
    ...
    \ on a DC 21 Strength saving throw or be knocked [prone](/CLI/conditions.md#Prone)."
  "name": "Hoof"
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/goristro.webp"
```
^statblock