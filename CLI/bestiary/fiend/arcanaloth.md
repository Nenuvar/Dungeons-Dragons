...
- "desc": "The arcanaloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\nAt will: [alter self](/CLI/spells/alter-self.md), [darkness](/CLI/spells/darkness.md),\
    \ [heat metal](/CLI/spells/heat-metal.md), [invisibility](/CLI/spells/invisibility.md)\
    \ (self only), [magic missile](/CLI/spells/magic-missile.md)"
...
- "desc": "The arcanaloth is a 16th-level spellcaster. Its spellcasting ability is\
    ...
    \ [mage hand](/CLI/spells/mage-hand.md), [minor illusion](/CLI/spells/minor-illusion.md),\
    \ [prestidigitation](/CLI/spells/prestidigitation.md)\n\n1st level (4 slots):\
    \ [detect magic](/CLI/spells/detect-magic.md), [identify](/CLI/spells/identify.md),\
    \ [shield](/CLI/spells/shield.md), [Tenser's floating disk](/CLI/spells/tensers-floating-disk.md)\n\
    \n2nd level (3 slots): [detect thoughts](/CLI/spells/detect-thoughts.md),\
    \ [mirror image](/CLI/spells/mirror-image.md), [phantasmal force](/CLI/spells/phantasmal-force.md),\
    \ [suggestion](/CLI/spells/suggestion.md)\n\n3rd level (3 slots): [counterspell](/CLI/spells/counterspell.md),\
    \ [fear](/CLI/spells/fear.md), [fireball](/CLI/spells/fireball.md)\n\n4th level\
    \ (3 slots): [banishment](/CLI/spells/banishment.md), [dimension door](/CLI/spells/dimension-door.md)\n\
    ...
    \ lightning](/CLI/spells/chain-lightning.md)\n\n7th level (1 slots): [finger\
    \ of death](/CLI/spells/finger-of-death.md)\n\n8th level (1 slots): [mind\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/arcanaloth.webp"
```
^statblock