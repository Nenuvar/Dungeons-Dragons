...
- "desc": "The glabrezu's spellcasting ability is Intelligence (spell save DC 16).\
    ...
    \nAt will: [darkness](/CLI/spells/darkness.md), [detect magic](/CLI/spells/detect-magic.md),\
    \ [dispel magic](/CLI/spells/dispel-magic.md)\n\n1/day each: [confusion](/CLI/spells/confusion.md),\
    \ [fly](/CLI/spells/fly.md), [power word stun](/CLI/spells/power-word-stun.md)"
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 16\
    ...
    \ it is [grappled](/CLI/conditions.md#Grappled) (escape DC 15). The glabrezu has\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/glabrezu.webp"
```
^statblock