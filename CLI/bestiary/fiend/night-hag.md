...
- "desc": "The hag's innate spellcasting ability is Charisma (spell save DC 14, +6\
    ...
    \ [magic missile](/CLI/spells/magic-missile.md)\n\n2/day each: [plane shift](/CLI/spells/plane-shift.md)\
    \ (self only), [ray of enfeeblement](/CLI/spells/ray-of-enfeeblement.md), [sleep](/CLI/spells/sleep.md)"
...
- "desc": "While on the Ethereal Plane, the hag magically touches a sleeping humanoid\
    \ on the Material Plane. A [protection from evil and good](/CLI/spells/protection-from-evil-and-good.md)\
    ...
    \ lasts until removed by the  [greater restoration](/CLI/spells/greater-restoration.md)\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/night-hag.webp"
```
^statblock