...
- "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The barlgura\
    ...
    1/day each: [entangle](/CLI/spells/entangle.md), [phantasmal force](/CLI/spells/phantasmal-force.md)\n\
    \n2/day each: [disguise self](/CLI/spells/disguise-self.md), [invisibility](/CLI/spells/invisibility.md)\
    \ (self only)"
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/barlgura.webp"
```
^statblock