...
- Hezrou
---
# [Hezrou](CLI/bestiary/fiend/hezrou.md)
...
- "desc": "Any creature that starts its turn within 10 feet of the hezrou must succeed\
    \ on a DC 14 Constitution saving throw or be [poisoned](/CLI/conditions.md#Poisoned)\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/fiend/token/hezrou.webp"
```
^statblock