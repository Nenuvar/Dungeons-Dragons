...
- "desc": "The yochlol's spellcasting ability is Charisma (spell save DC 14). The\
    ...
    \nAt will: [detect thoughts](/CLI/spells/detect-thoughts.md), [web](/CLI/spells/web.md)\n\
    \n1/day: [dominate person](/CLI/spells/dominate-person.md)"
...
- "desc": "The yochlol transforms into toxic mist or reverts to its true form. Any\
    ...
    \ form if it dies.\n\nWhile in mist form, the yochlol is [incapacitated](/CLI/conditions.md#Incapacitated)\
    ...
    \ until the start of its next turn. While [poisoned](/CLI/conditions.md#Poisoned)\
    \ in this way, the target is [incapacitated](/CLI/conditions.md#Incapacitated)."
  "name": "Mist Form"
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/yochlol.webp"
```
^statblock