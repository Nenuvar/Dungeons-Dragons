...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ [grappled](/CLI/conditions.md#Grappled) (escape DC 19). Until this grapple ends,\
    \ the target is [restrained](/CLI/conditions.md#Restrained), the marilith can\
    \ automatically hit the target with its tail, and the marilith can't make tail\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/marilith.webp"
```
^statblock