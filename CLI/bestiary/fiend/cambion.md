...
- "desc": "The cambion's spellcasting ability is Charisma (spell save DC 14). The\
    ...
    \ each: [alter self](/CLI/spells/alter-self.md), [command](/CLI/spells/command.md),\
...
- "desc": "One humanoid the cambion can see within 30 feet of it must succeed on a\
    \ DC 14 Wisdom saving throw or be magically [charmed](/CLI/conditions.md#Charmed)\
    \ for 1 day. The [charmed](/CLI/conditions.md#Charmed) target obeys the cambion's\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/cambion.webp"
```
^statblock
