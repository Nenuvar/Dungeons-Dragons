...
- "desc": "The devil can't be [frightened](/CLI/conditions.md#Frightened) while it\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
    ...
    \ saving throw or be [poisoned](/CLI/conditions.md#Poisoned) for 1 minute. While\
    \ [poisoned](/CLI/conditions.md#Poisoned) in this way, the target can't regain\
    \ hit points. The target can repeat the saving throw at the end of each of its\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 8\
    ...
    \ the wound with a successful DC 12 Wisdom ([Medicine](/CLI/skills.md#Medicine))\
    \ check. The wound also closes if the target receives magical healing."
  "name": "Glaive"
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/bearded-devil.webp"
```
^statblock