...
> 
> Some erinyes carry a [rope of entanglement](/CLI/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
...
- "desc": "Ranged Weapon Attack: +7 to hit, range 150/600 ft., one target. Hit:\
    ...
    \ must succeed on a DC 14 Constitution saving throw or be [poisoned](/CLI/conditions.md#Poisoned).\
    \ The poison lasts until it is removed by the [lesser restoration](/CLI/spells/lesser-restoration.md)\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/erinyes.webp"
```
^statblock