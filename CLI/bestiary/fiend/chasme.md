...
- "desc": "The chasme produces a horrid droning sound to which demons are immune.\
    ...
    \ on a DC 12 Constitution saving throw or fall [unconscious](/CLI/conditions.md#Unconscious)\
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 16\
    ...
    \ a long rest or until it is affected by a spell like  [greater restoration](/CLI/spells/greater-restoration.md)."
  "name": "Proboscis"
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/chasme.webp"
```
^statblock