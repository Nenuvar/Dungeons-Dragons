...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 11\
    \ (2d6 + 4) slashing damage. The target is [grappled](/CLI/conditions.md#Grappled)\
    \ (escape DC 14) if the devil isn't already grappling a creature. Until this grapple\
    \ ends, the target is [restrained](/CLI/conditions.md#Restrained) and takes 7\
...
- "desc": "Up to four chains the devil can see within 60 feet of it magically sprout\
    ...
    \ [incapacitated](/CLI/conditions.md#Incapacitated) or dies."
...
- "desc": "When a creature the devil can see starts its turn within 30 feet of the\
    ...
    \ must succeed on a DC 14 Wisdom saving throw or be [frightened](/CLI/conditions.md#Frightened)\
    \ until the end of its turn."
  "name": "Unnerving Mask"
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/chain-devil.webp"
```
^statblock