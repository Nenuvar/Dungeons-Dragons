...
- "desc": "The mezzoloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\n1/day: [cloudkill](/CLI/spells/cloudkill.md)\n\n2/day each:\
    \ [darkness](/CLI/spells/darkness.md), [dispel magic](/CLI/spells/dispel-magic.md)"
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/mezzoloth.webp"
```
^statblock