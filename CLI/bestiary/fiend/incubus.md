...
*Source: Monster Manual p. 285, The Wild Beyond the Witchlight. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
The succubus or incubus resorts to charming a victim magically only when necessary, usually as a form of self-defense. A [charmed](/CLI/conditions.md#Charmed) creature isn't responsible for its actions, so forcing it to behave against its will won't bring the fiend closer to the ultimate prize: the victim's soul.
...
Succubi and incubi can reproduce with one another to spawn more of their kind. Less commonly, a succubus or incubus reproduces with a humanoid. From this unholy union, a [cambion](/CLI/bestiary/fiend/cambion.md) child is conceived. Invariably, the fiendish offspring is as wicked as its fiendish parent.
...
- "desc": "The fiend ignores the range restriction on its telepathy when communicating\
    \ with a creature it has [charmed](/CLI/conditions.md#Charmed). The two don't\
...
- "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a DC\
    \ 15 Wisdom saving throw or be magically [charmed](/CLI/conditions.md#Charmed)\
    \ for 1 day. The [charmed](/CLI/conditions.md#Charmed) target obeys the fiend's\
    ...
    The fiend can have only one target [charmed](/CLI/conditions.md#Charmed) at a\
    \ time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "The fiend kisses a creature [charmed](/CLI/conditions.md#Charmed) by it\
    \ or a willing creature. The target must make a DC 15 Constitution saving throw\
    \ against this magic, taking 32 (5d10 + 5) psychic damage on a failed save,\
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/fiend/token/incubus.webp"
```
^statblock
