...
- "desc": "The ultroloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\nAt will: [alter self](/CLI/spells/alter-self.md), [clairvoyance](/CLI/spells/clairvoyance.md),\
    \ [darkness](/CLI/spells/darkness.md), [detect magic](/CLI/spells/detect-magic.md),\
    \ [detect thoughts](/CLI/spells/detect-thoughts.md), [dispel magic](/CLI/spells/dispel-magic.md),\
    \ [invisibility](/CLI/spells/invisibility.md) (self only), [suggestion](/CLI/spells/suggestion.md)\n\
    \n1/day each: [fire storm](/CLI/spells/fire-storm.md), [mass suggestion](/CLI/spells/mass-suggestion.md)\n\
    \n3/day each: [dimension door](/CLI/spells/dimension-door.md), [fear](/CLI/spells/fear.md),\
...
- "desc": "The ultroloth's eyes sparkle with opalescent light as it targets one creature\
    ...
    \ must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](/CLI/conditions.md#Charmed)\
    \ until the end of the ultroloth's next turn. The [charmed](/CLI/conditions.md#Charmed)\
    \ target is [stunned](/CLI/conditions.md#Stunned). If the target's saving throw\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/ultroloth.webp"
```
^statblock