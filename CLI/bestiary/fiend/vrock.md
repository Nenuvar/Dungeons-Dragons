...
- "desc": "A 15-foot-radius cloud of toxic spores extends out from the vrock. The\
    ...
    \ 14 Constitution saving throw or become [poisoned](/CLI/conditions.md#Poisoned).\
    \ While [poisoned](/CLI/conditions.md#Poisoned) in this way, a target takes 5\
    \ (1d10) poison damage at the start of each of its turns. A target can repeat\
...
- "desc": "The vrock emits a horrific screech. Each creature within 20 feet of it\
    ...
    \ saving throw or be [stunned](/CLI/conditions.md#Stunned) until the end of the\
    \ vrock's next turn."
  "name": "Stunning Screech (1/Day)"
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/vrock.webp"
```
^statblock