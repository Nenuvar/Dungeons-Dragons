...
- "desc": "The pit fiend's spellcasting ability is Charisma (spell save DC 21). The\
    ...
    \nAt will: [detect magic](/CLI/spells/detect-magic.md), [fireball](/CLI/spells/fireball.md)\n\
    \n3/day each: [hold monster](/CLI/spells/hold-monster.md), [wall of fire](/CLI/spells/wall-of-fire.md)"
...
- "desc": "Any creature hostile to the pit fiend that starts its turn within 20 feet\
    ...
    \ is [incapacitated](/CLI/conditions.md#Incapacitated). On a failed save, the\
    \ creature is [frightened](/CLI/conditions.md#Frightened) until the start of its\
...
- "desc": "Melee Weapon Attack: +14 to hit, reach 5 ft., one target. Hit: 22\
    ...
    \ saving throw or become [poisoned](/CLI/conditions.md#Poisoned). While [poisoned](/CLI/conditions.md#Poisoned)\
    \ in this way, the target can't regain hit points, and it takes 21 (6d6) poison\
    \ damage at the start of each of its turns. The [poisoned](/CLI/conditions.md#Poisoned)\
...
"source":
- "MM"
"image": "/CLI/bestiary/fiend/token/pit-fiend.webp"
```
^statblock