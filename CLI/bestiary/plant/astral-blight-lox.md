...
- Astral Blight
---
# [Astral Blight](CLI/bestiary/plant/astral-blight-lox.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ it is [grappled](/CLI/conditions.md#Grappled) (escape DC 13). Until this grapple\
...
"source":
- "LoX"
"image": "/CLI/bestiary/plant/token/astral-blight-lox.webp"
```
^statblock