...
At your discretion, a legendary ([adult](/CLI/bestiary/dragon/adult-gold-dragon.md) or [ancient](/CLI/bestiary/dragon/ancient-gold-dragon.md)) gold dragon can use the following additional lair action while in its lair:

- **Beguiling Glow.** Warm light fills a 30-foot-radius sphere centered on the dragon; each creature in that area must succeed on a DC 15 Wisdom saving throw or be [charmed](/CLI/conditions.md#Charmed) by the dragon until initiative count 20 on the next round.  
