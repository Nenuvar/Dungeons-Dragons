...
- The tomb trembles violently for a moment. Each creature on the floor of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](/CLI/conditions.md#Prone).  
- The demilich targets one creature it can see within 60 feet of it. An [antimagic field](/CLI/spells/antimagic-field.md) fills the space of the target, moving with it until initiative count 20 on the next round.  
...
- Monsters in the tomb have advantage on saving throws against being [charmed](/CLI/conditions.md#Charmed) or [frightened](/CLI/conditions.md#Frightened), and against features that turn undead.  
