...
- The hag chooses one humanoid within the lair and instantly creates a simulacrum of that creature (as if created with the [simulacrum](/CLI/spells/simulacrum.md) spell). This hideous simulacrum is formed out of seaweed, slime, half-eaten fish, and other garbage, but still generally resembles the creature it is imitating. This simulacrum obeys the hag's commands and is destroyed on initiative count 20 on the next round.  
...
- Beasts that have an Intelligence score of 2 or lower are [charmed](/CLI/conditions.md#Charmed) by the hag and directed to be aggressive toward intruders in the area.  
