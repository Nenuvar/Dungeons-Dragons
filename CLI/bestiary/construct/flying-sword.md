...
"cr": "1/4"
"traits":
- "desc": "The sword is [incapacitated](/CLI/conditions.md#Incapacitated) while in\
    \ the area of an [antimagic field](/CLI/spells/antimagic-field.md). If targeted\
    \ by [dispel magic](/CLI/spells/dispel-magic.md), the sword must succeed on a\
...
"source":
- "MM"
"image": "/CLI/bestiary/construct/token/flying-sword.webp"
```
^statblock