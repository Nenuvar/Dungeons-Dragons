...
- "desc": "Whenever the golem starts its turn with 40 hit points or fewer, roll a\
    ...
    \ a DC 15 Charisma ([Persuasion](/CLI/skills.md#Persuasion)) check. If the check\
    \ succeeds, the golem ceases being berserk. If it takes damage while still at\
    \ 40 hit points or fewer, the golem might go berserk again."
  "name": "Berserk"
...
"source":
- "MM"
"image": "/CLI/bestiary/construct/token/flesh-golem.webp"
```
^statblock