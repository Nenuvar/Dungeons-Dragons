...
- Glasswork Golem
---
# [Glasswork Golem](CLI/bestiary/construct/glasswork-golem-wbtw.md)
...
- "desc": "If the golem is embedded in a window and motionless at the start of combat,\
    ...
    \ the golem move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](/CLI/skills.md#Investigation))\
...
- "desc": "Magical, colored light springs from the golem in a 15-foot cone. Each creature\
    \ in the cone must succeed on a DC 10 Constitution saving throw or be [blinded](/CLI/conditions.md#Blinded)\
