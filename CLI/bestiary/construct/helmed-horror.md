...
- "desc": "The helmed horror is immune to three spells chosen by its creator. Typical\
    \ immunities include [fireball](/CLI/spells/fireball.md), [heat metal](/CLI/spells/heat-metal.md),\
    \ and [lightning bolt](/CLI/spells/lightning-bolt.md)."
  "name": "Spell Immunity"
"actions":
...
"source":
- "MM"
"image": "/CLI/bestiary/construct/token/helmed-horror.webp"
```
^statblock