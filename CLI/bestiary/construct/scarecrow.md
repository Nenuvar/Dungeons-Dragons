...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one target. Hit: 6 (2d4\
    ...
    \ 11 Wisdom saving throw or be [frightened](/CLI/conditions.md#Frightened) until\
...
- "desc": "The scarecrow targets one creature it can see within 30 feet of it. If\
    ...
    \ saving throw or be magically [frightened](/CLI/conditions.md#Frightened) until\
    \ the end of the scarecrow's next turn. The [frightened](/CLI/conditions.md#Frightened)\
    \ target is [paralyzed](/CLI/conditions.md#Paralyzed)."
  "name": "Terrifying Glare"
"source":
- "MM"
"image": "/CLI/bestiary/construct/token/scarecrow.webp"
```
^statblock
