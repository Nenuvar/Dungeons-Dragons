...
- Prince Xeleth
---
# [Prince Xeleth](CLI/bestiary/npc/prince-xeleth-lox.md)
...
- "desc": "Xeleth casts one of the following spells, using Intelligence as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](/CLI/conditions.md#Charmed)\
    \ condition on itself, and magic can't put it to sleep."
  "name": "Fey Ancestry"
- "desc": "Xeleth wears a suit of [elven chain](/CLI/items/elven-chain.md)."
...
- "desc": "Xeleth has a 50 percent chance of magically summoning a [young solar dragon](/CLI/bestiary/dragon/young-solar-dragon-bam.md).\
...
"source":
- "LoX"
"image": "/CLI/bestiary/npc/token/prince-xeleth-lox.webp"
```
^statblock