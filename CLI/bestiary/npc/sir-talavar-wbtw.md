...
- "desc": "Sir Talavar's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \n1/day: [color spray](/CLI/spells/color-spray.md) (Orange), [mirror image](/CLI/spells/mirror-image.md)\
    \ (Yellow), [suggestion](/CLI/spells/suggestion.md) (Green), [major image](/CLI/spells/major-image.md)\
    \ (Blue), [hallucinatory terrain](/CLI/spells/hallucinatory-terrain.md) (Indigo),\
    \ [polymorph](/CLI/spells/polymorph.md) (Violet)\n\n1/day each: [dancing lights](/CLI/spells/dancing-lights.md),\
    \ [mage hand](/CLI/spells/mage-hand.md), [minor illusion](/CLI/spells/minor-illusion.md)"
  "name": "Innate Spellcasting"
- "desc": "As a bonus action, Sir Talavar can magically turn [invisible](/CLI/conditions.md#Invisible)\
    \ until his [concentration](/CLI/conditions.md#Concentration) ends (as if [concentrating](/CLI/conditions.md#Concentration)\
    \ on a spell). Any equipment Sir Talavar wears or carries is [invisible](/CLI/conditions.md#Invisible)\
    \ with him."
