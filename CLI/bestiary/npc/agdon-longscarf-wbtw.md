...
- Agdon Longscarf
---
# [Agdon Longscarf](CLI/bestiary/npc/agdon-longscarf-wbtw.md)
...
- "desc": "If Agdon is subjected to an effect that allows him to make a Dexterity\
    ...
    \ on the saving throw and only half damage if he fails, provided he isn't [incapacitated](/CLI/conditions.md#Incapacitated)."
  "name": "Evasion"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 10\
    \ (3d6) fire damage, and the target is magically branded. Agdon is [invisible](/CLI/conditions.md#Invisible)\
...
- "desc": "Agdon targets one creature within 5 feet of him that he can see and makes\
    \ a Dexterity ([Sleight of Hand](/CLI/skills.md#Sleight%20of%20Hand)) check, with\
    \ a DC equal to 1 + the target's passive Wisdom ([Perception](/CLI/skills.md#Perception))\
