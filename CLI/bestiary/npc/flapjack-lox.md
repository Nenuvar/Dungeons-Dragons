...
- Flapjack
---
# [Flapjack](CLI/bestiary/npc/flapjack-lox.md)
...
- "desc": "Flapjack casts one of the following spells, requiring no material components\
    ...
    \ will: [mage hand](/CLI/spells/mage-hand.md), [minor illusion](/CLI/spells/minor-illusion.md)\n\
...
- "desc": "If Flapjack is knocked [prone](/CLI/conditions.md#Prone), roll a die. On\
    \ an odd result, Flapjack lands upside-down and is [incapacitated](/CLI/conditions.md#Incapacitated).\
...
"source":
- "LoX"
"image": "/CLI/bestiary/npc/token/flapjack-lox.webp"
```
^statblock