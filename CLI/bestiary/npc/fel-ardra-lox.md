...
- Fel Ardra
---
# [Fel Ardra](CLI/bestiary/npc/fel-ardra-lox.md)
...
- "desc": "Fel is a 4th-level spellcaster. Its spellcasting ability is Wisdom (spell\
    ...
    \ prepared:\n\nCantrips (at will): [light](/CLI/spells/light.md), [sacred\
    \ flame](/CLI/spells/sacred-flame.md), [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\
  ...
  "name": "Spellcasting"
- "desc": "Fel\n\nAt will: [thaumaturgy](/CLI/spells/thaumaturgy.md)\n\n1/day\
    \ each: [darkness](/CLI/spells/darkness.md), [hellish rebuke](/CLI/spells/hellish-rebuke.md)"
  "name": "Innate Spellcasting"
- "desc": "Fel has advantage on saving throws against being [charmed](/CLI/conditions.md#Charmed)\
...
"source":
- "LoX"
"image": "/CLI/bestiary/npc/token/fel-ardra-lox.webp"
```
^statblock