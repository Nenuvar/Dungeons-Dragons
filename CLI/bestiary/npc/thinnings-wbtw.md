...
- Thinnings
---
# [Thinnings](CLI/bestiary/npc/thinnings-wbtw.md)
...
- "desc": "Thinnings deals an extra 7 (2d6) damage when it hits a target with a\
    ...
    \ 5 feet of an ally of Thinnings that isn't [incapacitated](/CLI/conditions.md#Incapacitated)\
...
"source":
- "WBtW"
"image": "/CLI/bestiary/npc/token/thinnings-wbtw.webp"
```
^statblock