...
"condition_immunities": "[blinded](/CLI/conditions.md#Blinded), [deafened](/CLI/conditions.md#Deafened),\
  \ [petrified](/CLI/conditions.md#Petrified), [stunned](/CLI/conditions.md#Stunned)"
...
- "desc": "While carrying the [Witchlight vane](/CLI/items/witchlight-vane-wbtw.md),\
    ...
    \ attacks):\n\nAt will: [dancing lights](/CLI/spells/dancing-lights.md), [polymorph](/CLI/spells/polymorph.md)\
    \ (after casting, roll a d8; on a roll of 3 or 8, Light can't cast the spell\
    \ again until the next dawn), [ray of frost](/CLI/spells/ray-of-frost.md)"
  "name": "Spellcasting"
- "desc": "Light has advantage on saving throws against being [charmed](/CLI/conditions.md#Charmed),\
...
"actions":
- "desc": "Light makes two [Witchlight vane](/CLI/items/witchlight-vane-wbtw.md) attacks."
  "name": "Multiattack"
