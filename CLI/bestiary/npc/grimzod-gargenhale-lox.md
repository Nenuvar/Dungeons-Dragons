...
- Grimzod Gargenhale
---
# [Grimzod Gargenhale](CLI/bestiary/npc/grimzod-gargenhale-lox.md)
...
- "desc": "A ship upon which Grimzod stands, along with all creatures and objects\
    ...
    \ aboard the ship. Grimzod must concentrate on this magical effect to maintain\
    \ it (as if [concentrating](/CLI/conditions.md#Concentration) on a spell), and\
    \ it lasts for up to 1 hour. The effect ends if Grimzod leaves the ship."
...
"source":
- "LoX"
"image": "/CLI/bestiary/npc/token/grimzod-gargenhale-lox.webp"
```
^statblock