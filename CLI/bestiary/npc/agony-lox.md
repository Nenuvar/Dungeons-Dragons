...
- Agony
---
# [Agony](CLI/bestiary/npc/agony-lox.md)
...
- "desc": "Each non-undead creature within 60 feet of Agony that can see it must succeed\
    \ on a DC 13 Wisdom saving throw or be [frightened](/CLI/conditions.md#Frightened)\
...
- "desc": "One humanoid that Agony can see within 5 feet of it must succeed on a DC\
    ...
    \ the target is [incapacitated](/CLI/conditions.md#Incapacitated) and loses control\
    \ of its body. Agony now controls the body but doesn't deprive the target of awareness.\
    \ Agony can't be targeted by any attack, spell, or other effect, except ones that\
    \ turn undead, and it retains its alignment, Intelligence, Wisdom, Charisma, and\
    \ immunity to being [charmed](/CLI/conditions.md#Charmed) and [frightened](/CLI/conditions.md#Frightened).\
    ...
    \ or Agony is turned or forced out by an effect like the [dispel evil and good](/CLI/spells/dispel-evil-and-good.md)\
...
"source":
- "LoX"
"image": "/CLI/bestiary/npc/token/agony-lox.webp"
```
^statblock