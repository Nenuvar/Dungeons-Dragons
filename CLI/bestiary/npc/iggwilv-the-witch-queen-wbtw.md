...
"ac": !!int "19"
"ac_class": "[robe of the archmagi](/CLI/items/robe-of-the-archmagi.md)"
"hp": !!int "255"
"hit_dice": "30d8 + 120"
"stats":
- !!int "10"
...
- "desc": "Iggwilv casts one of the following spells, requiring no material components\
    ...
    \ [disguise self](/CLI/spells/disguise-self.md), [invisibility](/CLI/spells/invisibility.md),\
    \ [light](/CLI/spells/light.md), [mage hand](/CLI/spells/mage-hand.md), [message](/CLI/spells/message.md),\
    \ [prestidigitation](/CLI/spells/prestidigitation.md), [Tasha's hideous laughter](/CLI/spells/tashas-hideous-laughter.md)\n\
    \n1/day each: [maze](/CLI/spells/maze.md), [telekinesis](/CLI/spells/telekinesis.md),\
    \ [teleport](/CLI/spells/teleport.md), [wish](/CLI/spells/wish.md)\n\n3/day\
    \ each: [dispel magic](/CLI/spells/dispel-magic.md), [fly](/CLI/spells/fly.md),\
...
- "desc": "Iggwilv wears an [amulet of the planes](/CLI/items/amulet-of-the-planes.md)\
    \ and a [robe of the archmagi](/CLI/items/robe-of-the-archmagi.md)."
...
- "desc": "Melee or Ranged Spell Attack: +16 to hit, reach 5 ft. or range 120\
    ...
    \ a creature, it must succeed on a DC 22 Wisdom saving throw or be [charmed](/CLI/conditions.md#Charmed)\
...
- "desc": "Iggwilv opens a momentary Abyssal rift within 120 feet of her. The rift\
    ...
    \ 3 [hezrous](/CLI/bestiary/fiend/hezrou.md) then appear in unoccupied spaces\
...
- "desc": "Iggwilv utters a phrase in a forbidden language and targets one or two\
    ...
    \ 22 Wisdom saving throw or take 11 (2d10) psychic damage and be [frightened](/CLI/conditions.md#Frightened)\
