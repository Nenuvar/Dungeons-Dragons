...
"ac": !!int "15"
"ac_class": "[+1 leather armor](/CLI/items/1-armor.md)"
"hp": !!int "60"
"hit_dice": "8d8 + 24"
"stats":
- !!int "9"
...
- "desc": "When subjected to an effect that allows a Dexterity saving throw to take\
    ...
    \ on a failed one, provided Molliver is not [incapacitated](/CLI/conditions.md#Incapacitated)."
  "name": "Evasion"
- "desc": "Molliver wears [+1 leather armor](/CLI/items/1-armor.md) and [boots of\
    \ levitation](/CLI/items/boots-of-levitation.md)."
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 6\
  ...
  "name": "Shortsword"
- "desc": "While wearing boots of levitation, Molliver casts [levitate](/CLI/spells/levitate.md)\
    \ (self only)."
  "name": "Levitate"
"reactions":
