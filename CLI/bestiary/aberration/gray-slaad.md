...
*Source: Monster Manual p. 277, The Wild Beyond the Witchlight*  
...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \nAt will: [detect magic](/CLI/spells/detect-magic.md), [detect thoughts](/CLI/spells/detect-thoughts.md),\
    \ [invisibility](/CLI/spells/invisibility.md) (self only), [mage hand](/CLI/spells/mage-hand.md),\
    \ [major image](/CLI/spells/major-image.md)\n\n1/day: [plane shift](/CLI/spells/plane-shift.md)\
    \ (self only)\n\n2/day each: [fear](/CLI/spells/fear.md), [fly](/CLI/spells/fly.md),\
    \ [fireball](/CLI/spells/fireball.md), [tongues](/CLI/spells/tongues.md)"
...
- "MM"
- "WBtW"
"image": "/CLI/bestiary/aberration/token/gray-slaad.webp"
```
^statblock
