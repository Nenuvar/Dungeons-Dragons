...
- Zodar
---
# [Zodar](CLI/bestiary/aberration/zodar-bam.md)
...
"cr": "16"
"traits":
- "desc": "The zodar casts the [wish](/CLI/spells/wish.md) spell, requiring no spell\
    \ components and using Charisma as the spellcasting ability (spell save DC 17).\
    \ After casting this spell, the zodar turns to dust and is destroyed.\n\nAt\
    \ will: "
  "name": "Wish"
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/aberration/token/zodar-bam.webp"
```
^statblock