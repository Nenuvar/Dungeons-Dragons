...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \ [mage hand](/CLI/spells/mage-hand.md)\n\n1/day: [fireball](/CLI/spells/fireball.md)\n\
    \n2/day each: [fear](/CLI/spells/fear.md), [invisibility](/CLI/spells/invisibility.md)\
    \ (self only)"
...
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/green-slaad.webp"
```
^statblock