...
"cr": "2"
"traits":
- "desc": "The nothic has advantage on Wisdom ([Perception](/CLI/skills.md#Perception))\
...
- "desc": "The nothic targets one creature it can see within 30 feet of it. The target\
  ...
  "name": "Rotting Gaze"
- "desc": "The nothic targets one creature it can see within 30 feet of it. The target\
    \ must contest its Charisma ([Deception](/CLI/skills.md#Deception)) check against\
    \ the nothic's Wisdom ([Insight](/CLI/skills.md#Insight)) check. If the nothic\
    \ wins, it magically learns one fact or secret about the target. The target automatically\
    \ wins if it is immune to being [charmed](/CLI/conditions.md#Charmed)."
  "name": "Weird Insight"
"source":
- "MM"
- "LMoP"
"image": "/CLI/bestiary/aberration/token/nothic.webp"
```
^statblock
