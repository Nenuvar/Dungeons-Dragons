...
"condition_immunities": "[blinded](/CLI/conditions.md#Blinded), [prone](/CLI/conditions.md#Prone)"
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one creature. Hit:\
    ...
    \ saving throw or be [poisoned](/CLI/conditions.md#Poisoned) for 1 minute. The\
    \ [poisoned](/CLI/conditions.md#Poisoned) target is [paralyzed](/CLI/conditions.md#Paralyzed),\
    \ and it can repeat the saving throw at the end of each of its turns, ending the\
    \ effect on a success.\n\nThe target is also [grappled](/CLI/conditions.md#Grappled)\
    \ (escape DC 15). If the target is Medium or smaller, it is also [restrained](/CLI/conditions.md#Restrained)\
...
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/grell.webp"
```
^statblock
