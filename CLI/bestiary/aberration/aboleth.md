...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 12\
    ...
    \ only by [heal](/CLI/spells/heal.md) or another disease-curing spell of 6th level\
    \ or higher. When the creature is outside a body of water, it takes 6 (1d12)\
...
- "desc": "The aboleth targets one creature it can see within 30 feet of it. The target\
    \ must succeed on a DC 14 Wisdom saving throw or be magically [charmed](/CLI/conditions.md#Charmed)\
    \ by the aboleth until the aboleth dies or until it is on a different plane of\
    \ existence from the target. The [charmed](/CLI/conditions.md#Charmed) target\
    ...
    \nWhenever the [charmed](/CLI/conditions.md#Charmed) target takes damage, the\
  ...
  "name": "Enslave (3/Day)"
"legendary_actions":
- "desc": "The aboleth makes a Wisdom ([Perception](/CLI/skills.md#Perception)) check."
  "name": "Detect"
- "desc": "The aboleth makes one tail attack."
  "name": "Tail Swipe"
- "desc": "One creature [charmed](/CLI/conditions.md#Charmed) by the aboleth takes\
...
- "desc": "When fighting inside its lair, an aboleth can invoke the ambient magic\
  ...
  "name": ""
- "desc": "- The aboleth casts [phantasmal force](/CLI/spells/phantasmal-force.md)\
    \ (no components required) on any number of creatures it can see within 60 feet\
    \ of it. While maintaining [concentration](/CLI/conditions.md#Concentration) on\
    \ this effect, the aboleth can't take other lair actions. If a target succeeds\
    ...
    \ up to 20 feet into the water and knocked [prone](/CLI/conditions.md#Prone).\
...
- "desc": "- Underground surfaces within 1 mile of the aboleth's lair are slimy and\
    ...
    \ aboleth has seen before or in any location a creature [charmed](/CLI/conditions.md#Charmed)\
    \ by the aboleth can currently see. Once created, the image lasts for as long\
    \ as the aboleth maintains [concentration](/CLI/conditions.md#Concentration),\
    \ as if [concentrating](/CLI/conditions.md#Concentration) on a spell. Although\
    \ the image is intangible, it looks, sounds, and can move like the aboleth. The\
    \ aboleth can sense, speak, and use telepathy from the image's position as if\
    \ present at that position. If the image takes any damage, it disappears.  "
  "name": ""
...
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/aboleth.webp"
```
^statblock
