...
- "desc": "The mind flayer's innate spellcasting ability is Intelligence (spell save\
    ...
    \nAt will: [detect thoughts](/CLI/spells/detect-thoughts.md), [levitate](/CLI/spells/levitate.md)\n\
    \n1/day each: [dominate monster](/CLI/spells/dominate-monster.md), [plane\
    \ shift](/CLI/spells/plane-shift.md) (self only)"
...
- "desc": "The mind flayer is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ the following wizard spells prepared:\n\nCantrips (at will): [blade ward](/CLI/spells/blade-ward.md),\
    \ [dancing lights](/CLI/spells/dancing-lights.md), [mage hand](/CLI/spells/mage-hand.md),\
    \ [shocking grasp](/CLI/spells/shocking-grasp.md)\n\n1st level (4 slots):\
    \ [detect magic](/CLI/spells/detect-magic.md), [disguise self](/CLI/spells/disguise-self.md),\
    \ [shield](/CLI/spells/shield.md), [sleep](/CLI/spells/sleep.md)\n\n2nd level\
    \ (3 slots): [blur](/CLI/spells/blur.md), [invisibility](/CLI/spells/invisibility.md),\
    \ [ray of enfeeblement](/CLI/spells/ray-of-enfeeblement.md)\n\n3rd level (3\
    \ slots): [clairvoyance](/CLI/spells/clairvoyance.md), [lightning bolt](/CLI/spells/lightning-bolt.md),\
    \ [sending](/CLI/spells/sending.md)\n\n4th level (3 slots): [confusion](/CLI/spells/confusion.md),\
    \ [hallucinatory terrain](/CLI/spells/hallucinatory-terrain.md)\n\n5th level\
    \ (2 slots): [telekinesis](/CLI/spells/telekinesis.md), [wall of force](/CLI/spells/wall-of-force.md)"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one creature. Hit: 15\
    \ (2d10 + 4) psychic damage. If the target is Medium or smaller, it is [grappled](/CLI/conditions.md#Grappled)\
    \ (escape DC 15) and must succeed on a DC 15 Intelligence saving throw or be [stunned](/CLI/conditions.md#Stunned)\
    \ until this grapple ends."
  "name": "Tentacles"
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one [incapacitated](/CLI/conditions.md#Incapacitated)\
    \ humanoid [grappled](/CLI/conditions.md#Grappled) by the mind flayer. Hit:\
...
- "desc": "The mind flayer magically emits psychic energy in a 60-foot cone. Each\
    ...
    \ 22 (4d8 + 4) psychic damage and be [stunned](/CLI/conditions.md#Stunned) for\
    \ 1 minute. A creature can repeat the saving throw at the end of each of its turns,\
    \ ending the effect on itself on a success."
  "name": "Mind Blast (Recharge 5-6)"
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/mind-flayer-arcanist.webp"
```
^statblock
