...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](/CLI/conditions.md#Petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
...
"skillsaves":
  "Perception": !!int "12"
"condition_immunities": "[prone](/CLI/conditions.md#Prone)"
"senses": "darkvision 120 ft., passive Perception 22"
"languages": "Deep Speech, Undercommon"
"cr": "13"
"traits":
- "desc": "The beholder's central eye creates an area of antimagic, as in the [antimagic\
    \ field](/CLI/spells/antimagic-field.md) spell, in a 150-foot cone. At the start\
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ throw or be [charmed](/CLI/conditions.md#Charmed) by the beholder for 1 hour,\
    \ or until the beholder harms the creature.  \n- 2. Paralyzing Ray. The targeted\
    \ creature must succeed on a DC 16 Constitution saving throw or be [paralyzed](/CLI/conditions.md#Paralyzed)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 3. Fear Ray. The targeted\
    \ creature must succeed on a DC 16 Wisdom saving throw or be [frightened](/CLI/conditions.md#Frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 4. Slowing Ray. The\
    ...
    \ direction. It is [restrained](/CLI/conditions.md#Restrained) by the ray's telekinetic\
    \ grip until the start of the beholder's next turn or until the beholder is [incapacitated](/CLI/conditions.md#Incapacitated).\
    ...
    \ must succeed on a DC 16 Wisdom saving throw or fall asleep and remain [unconscious](/CLI/conditions.md#Unconscious)\
    ...
    \ DC 16 Dexterity saving throw or take 45 (10d8) force damage. If this damage\
...
- "desc": "- A 50-foot-square area of ground within 120 feet of the beholder becomes\
    ...
    \ DC 15 Dexterity saving throw or be [grappled](/CLI/conditions.md#Grappled).\
    \ Escaping requires a successful DC 15 Strength ([Athletics](/CLI/skills.md#Athletics))\
    \ or Dexterity ([Acrobatics](/CLI/skills.md#Acrobatics)) check.  \n- An eye opens\
    \ on a solid surface within 60 feet of the beholder. One random eye ray of the\
    \ beholder shoots from that eye at a target of the beholder's choice that it can\
    \ see. The eye then closes and disappears.  "
  "name": ""
...
- "MM"
- "LoX"
"image": "/CLI/bestiary/aberration/token/beholder.webp"
```
^statblock
