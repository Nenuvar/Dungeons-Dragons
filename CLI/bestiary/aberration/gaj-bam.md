...
- Gaj
---
# [Gaj](CLI/bestiary/aberration/gaj-bam.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one creature. Hit: 10\
    \ (2d6 + 3) slashing damage, and the target is [grappled](/CLI/conditions.md#Grappled)\
  ...
  "name": "Mandibles"
- "desc": "The gaj targets one creature [grappled](/CLI/conditions.md#Grappled) by\
    \ it. The target must make a DC 12 Wisdom saving throw. On a failed save, the\
...
- "desc": "The gaj magically targets one creature it can see within 60 feet of itself.\
    \ The target must succeed on a DC 12 Wisdom saving throw or be [paralyzed](/CLI/conditions.md#Paralyzed)\
...
- "BAM"
- "LoX"
"image": "/CLI/bestiary/aberration/token/gaj-bam.webp"
```
^statblock