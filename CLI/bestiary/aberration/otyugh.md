...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ a DC 15 Constitution saving throw against disease or become [poisoned](/CLI/conditions.md#Poisoned)\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 7\
    ...
    \ is Medium or smaller, it is [grappled](/CLI/conditions.md#Grappled) (escape\
    \ DC 13) and [restrained](/CLI/conditions.md#Restrained) until the grapple ends.\
    \ The otyugh has two tentacles, each of which can grapple one target."
  "name": "Tentacle"
- "desc": "The otyugh slams creatures [grappled](/CLI/conditions.md#Grappled) by it\
    \ into each other or a solid surface. Each creature must succeed on a DC 14 Constitution\
    \ saving throw or take 10 (2d6 + 3) bludgeoning damage and be [stunned](/CLI/conditions.md#Stunned)\
    \ until the end of the otyugh's next turn. On a successful save, the target takes\
    \ half the bludgeoning damage and isn't [stunned](/CLI/conditions.md#Stunned)."
  "name": "Tentacle Slam"
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/otyugh.webp"
```
^statblock
