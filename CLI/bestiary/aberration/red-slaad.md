...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d8\
    ...
    \ tadpole](/CLI/bestiary/aberration/slaad-tadpole.md). In the 24-hour period before\
    \ giving birth, the host starts to feel unwell, its speed is halved, and it has\
    \ disadvantage on attack rolls, ability checks, and saving throws. At birth, the\
    \ tadpole chews its way through vital organs and out of the host's chest in 1\
    \ round, killing the host in the process.\n\nIf the disease is cured before the\
    \ tadpole's emergence, the unborn slaad is disintegrated."
  "name": "Claw"
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/red-slaad.webp"
```
^statblock