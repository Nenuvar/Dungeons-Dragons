...
- "desc": "While in bright light, the cloaker has disadvantage on attack rolls and\
    \ Wisdom ([Perception](/CLI/skills.md#Perception)) checks that rely on sight."
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one creature. Hit: 10\
    ...
    \ attaches to the target's head, and the target is [blinded](/CLI/conditions.md#Blinded)\
...
- "desc": "Each creature within 60 feet of the cloaker that can hear its moan and\
    ...
    \ [frightened](/CLI/conditions.md#Frightened) until the end of the cloaker's next\
    \ turn. If a creature's saving throw is successful, the creature is immune to\
    \ the cloaker's moan for the next 24 hours."
  "name": "Moan"
...
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/cloaker.webp"
```
^statblock
