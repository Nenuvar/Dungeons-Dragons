...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 12\
    ...
    \ slaad](/CLI/bestiary/aberration/red-slaad.md) or, if it has the ability to cast\
    \ spells of 3rd level or higher, a [green slaad](/CLI/bestiary/aberration/green-slaad.md).\
    \ Only a [wish](/CLI/spells/wish.md) spell can reverse the transformation."
  "name": "Claw"
"source":
- "MM"
"image": "/CLI/bestiary/aberration/token/blue-slaad.webp"
```
^statblock