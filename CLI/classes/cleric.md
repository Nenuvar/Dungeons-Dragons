...
- **Tools**: none
- **Skills**: choose 2 from [History](/CLI/skills.md#History), [Insight](/CLI/skills.md#Insight), [Medicine](/CLI/skills.md#Medicine), [Persuasion](/CLI/skills.md#Persuasion), and [Religion](/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [mace](/CLI/items/mace.md) or (b) a [warhammer](/CLI/items/warhammer.md) (if proficient)
- (a) [scale mail](/CLI/items/scale-mail.md), (b) [leather armor](/CLI/items/leather-armor.md), or (c) [chain mail](/CLI/items/chain-mail.md) (if proficient)
...
- A [shield](/CLI/items/shield.md) and a [holy symbol](/CLI/items/holy-symbol.md)
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](/CLI/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](/CLI/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
