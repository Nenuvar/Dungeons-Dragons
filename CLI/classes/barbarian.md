...
- **Tools**: none
- **Skills**: choose 2 from [Animal Handling](/CLI/skills.md#Animal%20Handling), [Athletics](/CLI/skills.md#Athletics), [Intimidation](/CLI/skills.md#Intimidation), [Nature](/CLI/skills.md#Nature), [Perception](/CLI/skills.md#Perception), and [Survival](/CLI/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) a [greataxe](/CLI/items/greataxe.md) or (b) any martial melee weapon
- (a) two [handaxes](/CLI/items/handaxe.md) or (b) any simple weapon
- An [explorer's pack](/CLI/items/explorers-pack.md), and four [javelins](/CLI/items/javelin.md)
...
- **Armor**: [shields](/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](/CLI/backgrounds/outlander.md) background.
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](/CLI/conditions.md#Unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](/CLI/conditions.md#Blinded), [deafened](/CLI/conditions.md#Deafened), or [incapacitated](/CLI/conditions.md#Incapacitated).
...
Additionally, if you are [surprised](/CLI/conditions.md#Surprised) at the beginning of combat and aren't [incapacitated](/CLI/conditions.md#Incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](/CLI/conditions.md#Unconscious) or if you choose to end it.
