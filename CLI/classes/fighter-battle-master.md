...
- [Commander's Strike](/CLI/optional-features/commanders-strike.md)  
- [Disarming Attack](/CLI/optional-features/disarming-attack.md)  
- [Distracting Strike](/CLI/optional-features/distracting-strike.md)  
- [Evasive Footwork](/CLI/optional-features/evasive-footwork.md)  
- [Feinting Attack](/CLI/optional-features/feinting-attack.md)  
- [Goading Attack](/CLI/optional-features/goading-attack.md)  
- [Lunging Attack](/CLI/optional-features/lunging-attack.md)  
- [Maneuvering Attack](/CLI/optional-features/maneuvering-attack.md)  
- [Menacing Attack](/CLI/optional-features/menacing-attack.md)  
- [Parry](/CLI/optional-features/parry.md)  
- [Precision Attack](/CLI/optional-features/precision-attack.md)  
- [Pushing Attack](/CLI/optional-features/pushing-attack.md)  
- [Rally](/CLI/optional-features/rally.md)  
- [Riposte](/CLI/optional-features/riposte.md)  
- [Sweeping Attack](/CLI/optional-features/sweeping-attack.md)  
- [Trip Attack](/CLI/optional-features/trip-attack.md)  
...
If you have access to maneuvers, the following maneuvers are added to the list of options available to you. Maneuvers are available to Battle Masters but also to characters who have a special feature like the Superior Technique fighting style or the [Martial Adept](/CLI/feats/martial-adept.md) feat.
...
> ![Maneuver, Battle Master](/CLI/lists/list-optfeaturetype-mv-b.md#Maneuver,%20Battle%20Master)
