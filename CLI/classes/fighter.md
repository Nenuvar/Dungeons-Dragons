...
- **Tools**: none
- **Skills**: choose 2 from [Acrobatics](/CLI/skills.md#Acrobatics), [Animal Handling](/CLI/skills.md#Animal%20Handling), [Athletics](/CLI/skills.md#Athletics), [History](/CLI/skills.md#History), [Insight](/CLI/skills.md#Insight), [Intimidation](/CLI/skills.md#Intimidation), [Perception](/CLI/skills.md#Perception), and [Survival](/CLI/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) [chain mail](/CLI/items/chain-mail.md) or (b) [leather armor](/CLI/items/leather-armor.md), [longbow](/CLI/items/longbow.md), and [20 arrows](/CLI/items/arrows-20.md)
- (a) a martial weapon and a [shield](/CLI/items/shield.md) or (b) two martial weapons
- (a) a [light crossbow](/CLI/items/light-crossbow.md) and [20 bolts](/CLI/items/crossbow-bolts-20.md) or (b) two [handaxes](/CLI/items/handaxe.md)
...
You can make a fighter quickly by following these suggestions. First, make Strength or Dexterity your highest ability score, depending on whether you want to focus on melee weapons or on archery (or finesse weapons). Your next-highest score should be Constitution, or Intelligence if you plan to adopt the Eldritch Knight martial archetype. Second, choose the [soldier](/CLI/backgrounds/soldier.md) background.
...
- Replace a [fighting style](/CLI/lists/list-optfeaturetype-fs-f.md) you know with another fighting style available to fighters.  
- If you know any [maneuvers](/CLI/lists/list-optfeaturetype-mv-b.md) from the [Battle Master](/CLI/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
At 11th level, you can attack three times whenever you take the [Attack](/CLI/actions.md#Attack) action on your turn.
...
At 20th level, you can attack four times whenever you take the [Attack](/CLI/actions.md#Attack) action on your turn.

## Optional Features

> [!example]- Optional Features: Fighting Style, Fighter
> ![Fighting Style, Fighter](/CLI/lists/list-optfeaturetype-fs-f.md#Fighting%20Style,%20Fighter)
