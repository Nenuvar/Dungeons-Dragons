...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [charm person](/CLI/spells/charm-person.md), [disguise self](/CLI/spells/disguise-self.md) |
| 3rd | [mirror image](/CLI/spells/mirror-image.md), [pass without trace](/CLI/spells/pass-without-trace.md) |
| 5th | [blink](/CLI/spells/blink.md), [dispel magic](/CLI/spells/dispel-magic.md) |
| 7th | [dimension door](/CLI/spells/dimension-door.md), [polymorph](/CLI/spells/polymorph.md) |
| 9th | [dominate person](/CLI/spells/dominate-person.md), [modify memory](/CLI/spells/modify-memory.md) |
^trickery-domain-spells

### Blessing of the Trickster (Level 1)

Starting when you choose this domain at 1st level, you can use your action to touch a willing creature other than yourself to give it advantage on Dexterity ([Stealth](/CLI/skills.md#Stealth)) checks. This blessing lasts for 1 hour or until you use this feature again.

### Channel Divinity: Invoke Duplicity (Level 2)

Starting at 2nd level, you can use your Channel Divinity to create an illusory duplicate of yourself.

As an action, you create a perfect illusion of yourself that lasts for 1 minute, or until you lose your [concentration](/CLI/conditions.md#Concentration) (as if you were [concentrating](/CLI/conditions.md#Concentration) on a spell). The illusion appears in an unoccupied space that you can see within 30 feet of you. As a bonus action on your turn, you can move the illusion up to 30 feet to a space you can see, but it must remain within 120 feet of you.
...
As an action, you become [invisible](/CLI/conditions.md#Invisible) until the end of your next turn. You become visible if you attack or cast a spell.
