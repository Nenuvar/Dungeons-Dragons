...
- **Armor**: [light armor](/CLI/item-types.md#Light%20Armor), [medium armor](/CLI/item-types.md#Medium%20Armor), [shields](/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 3 from [Animal Handling](/CLI/skills.md#Animal%20Handling), [Athletics](/CLI/skills.md#Athletics), [Insight](/CLI/skills.md#Insight), [Investigation](/CLI/skills.md#Investigation), [Nature](/CLI/skills.md#Nature), [Perception](/CLI/skills.md#Perception), [Stealth](/CLI/skills.md#Stealth), and [Survival](/CLI/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) [scale mail](/CLI/items/scale-mail.md) or (b) [leather armor](/CLI/items/leather-armor.md)
- (a) two [shortswords](/CLI/items/shortsword.md) or (b) two simple melee weapons
- (a) a [dungeoneer's pack](/CLI/items/dungeoneers-pack.md) or (b) an [explorer's pack](/CLI/items/explorers-pack.md)
- A [longbow](/CLI/items/longbow.md) and a [quiver](/CLI/items/quiver.md) of [20 arrows](/CLI/items/arrows-20.md)
...
- **Armor**: [light armor](/CLI/item-types.md#Light%20Armor), [medium armor](/CLI/item-types.md#Medium%20Armor), [shields](/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Skills**: choose 1 from [Animal Handling](/CLI/skills.md#Animal%20Handling), [Athletics](/CLI/skills.md#Athletics), [Insight](/CLI/skills.md#Insight), [Investigation](/CLI/skills.md#Investigation), [Nature](/CLI/skills.md#Nature), [Perception](/CLI/skills.md#Perception), [Stealth](/CLI/skills.md#Stealth), and [Survival](/CLI/skills.md#Survival)
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](/CLI/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/CLI/bestiary/humanoid/gnoll.md) and [orcs](/CLI/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](/CLI/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](/CLI/conditions.md#Concentration) (as if you were [concentrating](/CLI/conditions.md#Concentration) on a spell).
...
For example, if you know the 1st-level spell [animal friendship](/CLI/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/CLI/spells/animal-friendship.md) using either slot.
...
You can use a [druidic focus](/CLI/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](/CLI/spells/speak-with-animals.md) |
| 5th | [beast sense](/CLI/spells/beast-sense.md) |
| 9th | [speak with plants](/CLI/spells/speak-with-plants.md) |
| 13th | [locate creature](/CLI/spells/locate-creature.md) |
| 17th | [commune with nature](/CLI/spells/commune-with-nature.md) |
^primal-awareness-spells
...
Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](/CLI/actions.md#Attack) action on your turn.
...
Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](/CLI/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.
...
You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](/CLI/conditions.md#Invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](/CLI/conditions.md#Exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](/CLI/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](/CLI/conditions.md#Invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](/CLI/conditions.md#Blinded) or [deafened](/CLI/conditions.md#Deafened).
...
> ![Fighting Style, Ranger](/CLI/lists/list-optfeaturetype-fs-r.md#Fighting%20Style,%20Ranger)
