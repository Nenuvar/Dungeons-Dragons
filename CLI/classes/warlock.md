...
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/CLI/skills.md#Arcana), [Deception](/CLI/skills.md#Deception), [History](/CLI/skills.md#History), [Intimidation](/CLI/skills.md#Intimidation), [Investigation](/CLI/skills.md#Investigation), [Nature](/CLI/skills.md#Nature), and [Religion](/CLI/skills.md#Religion)
...
- (a) a [scholar's pack](/CLI/items/scholars-pack.md) or (b) a [dungeoneer's pack](/CLI/items/dungeoneers-pack.md)
- [Leather armor](/CLI/items/leather-armor.md), any simple weapon, and two [daggers](/CLI/items/dagger.md)
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](/CLI/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](/CLI/spells/eldritch-blast.md) and [chill touch](/CLI/spells/chill-touch.md) cantrips, along with the 1st-level spells [charm person](/CLI/spells/charm-person.md) and [witch bolt](/CLI/spells/witch-bolt.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/CLI/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/CLI/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/CLI/lists/list-optfeaturetype-ei.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
> ![Eldritch Invocation](/CLI/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei

> [!example]- Optional Features: Pact Boon
> ![Pact Boon](/CLI/lists/list-optfeaturetype-pb.md#Pact%20Boon)
^list-optfeature-pb