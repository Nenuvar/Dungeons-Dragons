...
- **Armor**: none
- **Weapons**: [daggers](/CLI/items/dagger.md), [darts](/CLI/items/dart.md), [slings](/CLI/items/sling.md), [quarterstaffs](/CLI/items/quarterstaff.md), [light crossbows](/CLI/items/light-crossbow.md)
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/CLI/skills.md#Arcana), [Deception](/CLI/skills.md#Deception), [Insight](/CLI/skills.md#Insight), [Intimidation](/CLI/skills.md#Intimidation), [Persuasion](/CLI/skills.md#Persuasion), and [Religion](/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [light crossbow](/CLI/items/light-crossbow.md) and [20 bolts](/CLI/items/crossbow-bolts-20.md) or (b) any simple weapon
- (a) a [component pouch](/CLI/items/component-pouch.md) or (b) an [arcane focus](/CLI/items/arcane-focus.md)
- (a) a [dungeoneer's pack](/CLI/items/dungeoneers-pack.md) or (b) an [explorer's pack](/CLI/items/explorers-pack.md)
- Two [daggers](/CLI/items/dagger.md)
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](/CLI/spells/light.md), [prestidigitation](/CLI/spells/prestidigitation.md), [ray of frost](/CLI/spells/ray-of-frost.md), and [shocking grasp](/CLI/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](/CLI/spells/shield.md) and [magic missile](/CLI/spells/magic-missile.md).
...
For example, if you know the 1st-level spell [burning hands](/CLI/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/CLI/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](/CLI/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](/CLI/optional-features/careful-spell.md)  
- [Distant Spell](/CLI/optional-features/distant-spell.md)  
- [Empowered Spell](/CLI/optional-features/empowered-spell.md)  
- [Extended Spell](/CLI/optional-features/extended-spell.md)  
- [Heightened Spell](/CLI/optional-features/heightened-spell.md)  
- [Quickened Spell](/CLI/optional-features/quickened-spell.md)  
- [Subtle Spell](/CLI/optional-features/subtle-spell.md)  
- [Twinned Spell](/CLI/optional-features/twinned-spell.md)  
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](/CLI/lists/list-optfeaturetype-mm.md) available to you.  
...
> ![Metamagic](/CLI/lists/list-optfeaturetype-mm.md#Metamagic)
^list-optfeature-mm