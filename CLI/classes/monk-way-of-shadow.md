...
You can use your ki to duplicate the effects of certain spells. As an action, you can spend 2 ki points to cast [darkness](/CLI/spells/darkness.md), [darkvision](/CLI/spells/darkvision.md), [pass without trace](/CLI/spells/pass-without-trace.md), or [silence](/CLI/spells/silence.md), without providing material components. Additionally, you gain the [minor illusion](/CLI/spells/minor-illusion.md) cantrip if you don't already know it.
...
By 11th level, you have learned to become one with the shadows. When you are in an area of dim light or darkness, you can use your action to become [invisible](/CLI/conditions.md#Invisible). You remain [invisible](/CLI/conditions.md#Invisible) until you make an attack, cast a spell, or are in an area of bright light.
