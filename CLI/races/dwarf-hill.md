...
![](/CLI/races/img/dwarf.webp#right)
...
You have proficiency with the [battleaxe](/CLI/items/battleaxe.md), [handaxe](/CLI/items/handaxe.md), [light hammer](/CLI/items/light-hammer.md), and [warhammer](/CLI/items/warhammer.md).

### Tool Proficiency

You gain proficiency with the artisan's tools of your choice: [Smith's tools](/CLI/items/smiths-tools.md), [brewer's supplies](/CLI/items/brewers-supplies.md), or [mason's tools](/CLI/items/masons-tools.md).

### Stonecunning

Whenever you make an Intelligence ([History](/CLI/skills.md#History)) check related to the origin of stonework, you are considered proficient in the [History](/CLI/skills.md#History) skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.
