...
---
# Wand of Orcus
*Weapon ([mace](/CLI/items/mace.md)), wand, artifact (requires attunement)*  
![](/CLI/items/img/wand-of-orcus.webp#right)
...
Any creature besides Orcus that tries to attune to the wand must make a DC 17 Constitution saving throw. On a successful save, the creature takes `10d6` necrotic damage. On a failed save, the creature dies and rises as a [zombie](/CLI/bestiary/undead/zombie.md).

In the hands of one who is attuned to it, the wand can be wielded as a magic [mace](/CLI/items/mace.md) that grants a +3 bonus to attack and damage rolls made with it. The wand deals an extra `2d12` necrotic damage on a hit.
...
The wand has 7 charges. While holding it, you can use an action and expend 1 or more of its charges to cast one of the following spells (save DC 18) from it: [animate dead](/CLI/spells/animate-dead.md) (1 charge), [blight](/CLI/spells/blight.md) (2 charges), [circle of death](/CLI/spells/circle-of-death.md) (3 charges), [finger of death](/CLI/spells/finger-of-death.md) (3 charges), [power word kill](/CLI/spells/power-word-kill.md) (4 charges), or [speak with dead](/CLI/spells/speak-with-dead.md) (1 charge). The wand regains `1d4 + 3` expended charges daily at dawn.
...
The Wand of Orcus is a sentient, chaotic evil item with an Intelligence of 16, a Wisdom of 12, and a Charisma of 16. It has hearing and [darkvision](/CLI/senses.md#Darkvision) out to a range of 120 feet.
