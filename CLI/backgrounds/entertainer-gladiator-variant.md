...
- **Skill Proficiencies.** [Acrobatics](/CLI/skills.md#Acrobatics), [Performance](/CLI/skills.md#Performance)  
- **Tool Proficiencies.** [Disguise kit](/CLI/items/disguise-kit.md), one type of musical instrument  
- **Equipment.** An inexpensive but unusual weapon, such as a [trident](/CLI/items/trident.md) or [net](/CLI/items/net.md) (one of your choice), the favor of an admirer (love letter, lock of hair, or trinket), [costume clothes](/CLI/items/costume-clothes.md), and a belt [pouch](/CLI/items/pouch.md) containing 15 gp  
