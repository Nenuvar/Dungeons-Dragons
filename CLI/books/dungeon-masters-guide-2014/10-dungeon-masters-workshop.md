...
![Ability Check Proficiency by Class](/CLI/tables/ability-check-proficiency-by-class.md)
...
Consider using the [Sanity score](/CLI/variant-rules/new-ability-scores-honor-and-sanity.md) if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
![Explosives](/CLI/tables/explosives.md)
...
![Figuring Out Alien Technology](/CLI/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](/CLI/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](/CLI/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](/CLI/actions.md#Disarm)  
- [Mark](/CLI/actions.md#Mark)  
- [Overrun](/CLI/actions.md#Overrun)  
- [Shove Aside](/CLI/actions.md#Shove%20Aside)  
- [Tumble](/CLI/actions.md#Tumble)  
...
![Lingering Injuries](/CLI/tables/lingering-injuries.md)
...
![Massive Damage; System Shock](/CLI/tables/massive-damage-system-shock.md)
...
- The creature is [surprised](/CLI/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](/CLI/conditions.md#Surprised).  
- The group's leader is reduced to 0 hit points, [incapacitated](/CLI/conditions.md#Incapacitated), taken prisoner, or removed from battle.  
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](/CLI/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](/CLI/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](/CLI/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](/CLI/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](/CLI/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](/CLI/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](/CLI/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](/CLI/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](/CLI/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](/CLI/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](/CLI/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](/CLI/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](/CLI/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](/CLI/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](/CLI/races/aasimar-dmg.md).
