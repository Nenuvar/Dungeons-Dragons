...
![Identify the Party's Goals; Dungeon Goals](/CLI/tables/identify-the-partys-goals-dungeon-goals.md)

![Identify the Party's Goals; Wilderness Goals](/CLI/tables/identify-the-partys-goals-wilderness-goals.md)

![Identify the Party's Goals; Other Goals](/CLI/tables/identify-the-partys-goals-other-goals.md)
...
![Identify Important NPCs; Adventure Villains](/CLI/tables/identify-important-npcs-adventure-villains.md)

![Identify Important NPCs; Adventure Allies](/CLI/tables/identify-important-npcs-adventure-allies.md)

![Identify Important NPCs; Adventure Patrons](/CLI/tables/identify-important-npcs-adventure-patrons.md)
...
![Find the Ideal Introduction; Adventure Introduction](/CLI/tables/find-the-ideal-introduction-adventure-introduction.md)
...
![Consider the Ideal Climax; Adventure Climax](/CLI/tables/consider-the-ideal-climax-adventure-climax.md)
...
![Determine the Villain's Actions; Event-Based Villain Actions](/CLI/tables/determine-the-villains-actions-event-based-villain-actions.md)
...
![Determine the Party's Goals; Event-Based Goals](/CLI/tables/determine-the-partys-goals-event-based-goals.md)
...
![Framing Events](/CLI/tables/framing-events.md)
...
![Moral Quandaries](/CLI/tables/moral-quandaries.md)
...
![Side Quests](/CLI/tables/side-quests.md)
...
![Combat Encounter Difficulty; XP Thresholds by Character Level](/CLI/tables/combat-encounter-difficulty-xp-thresholds-by-character-level.md)
...
![Modify Total XP for Multiple Monsters; Encounter Multipliers](/CLI/tables/modify-total-xp-for-multiple-monsters-encounter-multipliers.md)
...
![The Adventuring Day; Adventuring Day XP](/CLI/tables/the-adventuring-day-adventuring-day-xp.md)
...
- The whole party is [surprised](/CLI/conditions.md#Surprised), and the enemy isn't.  
...
![Sylvan Forest Encounters](/CLI/tables/sylvan-forest-encounters.md)
