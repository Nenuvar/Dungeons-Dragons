...
![Recurring Expenses; Maintenance Costs](/CLI/tables/recurring-expenses-maintenance-costs.md)
...
- [Building a Stronghold](/CLI/variant-rules/downtime-activity-building-a-stronghold.md)  
- [Carousing](/CLI/variant-rules/downtime-activity-carousing.md)  
- [Crafting a Magic Item](/CLI/variant-rules/downtime-activity-crafting-a-magic-item.md)  
- [Gaining Renown](/CLI/variant-rules/downtime-activity-gaining-renown.md)  
- [Performing Sacred Rites](/CLI/variant-rules/downtime-activity-performing-sacred-rites.md)  
- [Running a Business](/CLI/variant-rules/downtime-activity-running-a-business.md)  
- [Selling Magic Items](/CLI/variant-rules/downtime-activity-selling-magic-items.md)  
- [Sowing Rumors](/CLI/variant-rules/downtime-activity-sowing-rumors.md)  
- [Training to Gain Levels](/CLI/variant-rules/downtime-activity-training-to-gain-levels.md)  
